...
type
  ...
  TTabGCForm = class(TModelPerTabPageControlPrincipaleForm)
    ...
    procedure btvGCMAG_DAORDINAREGetDataText(Sender: TcxCustomGridTableItem; ARecordIndex: Integer; var AText: String);
    procedure SbGcVisCommessaClick(Sender: TObject);
    procedure SbGcVisCommessaMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure SbGcVisMem1Click(Sender: TObject);
    procedure TimerAddMemoryGCTimer(Sender: TObject);
    procedure SbGcVisMem1MouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    ...
    procedure GCTipoMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    ...
    procedure GCMesiTuttiMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure GCMesiNessunoClick(Sender: TObject);
    procedure GCMesiNessunoMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure GCGenClick(Sender: TObject);
    procedure GCGenMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    ...
    procedure btvGCRighiCustomDrawCell(Sender: TcxCustomGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
    procedure btvGCRighiCustomDrawBandHeader(Sender: TcxGridBandedTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridBandHeaderViewInfo; var ADone: Boolean);
    procedure btvGCRighiCustomDrawColumnHeader(Sender: TcxGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridColumnHeaderViewInfo; var ADone: Boolean);
    procedure btvGCRighiTIPODOCUMENTOGetDisplayText(Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord; var AText: String);
    procedure QryNewGCGC_DESCRIZIONE_MODChange(Sender: TField);
    procedure QryNewGCGC_DESCRIZIONEChange(Sender: TField);
    procedure btvGCRighiSEGNOOPERAZIONEGetDisplayText(Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord; var AText: String);
    procedure btvGCRighiSEGNOOPERAZIONECANTIEREGetDisplayText(Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord; var AText: String);
    procedure btvGCRighiSOTTOCANTIERE1PropertiesInitPopup(Sender: TObject);
    procedure btvGCRighiSEGNOOPERAZIONECANTIEREPropertiesValidate(Sender: TObject; var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
    procedure btvGCRighiCustomDrawFooterCell(Sender: TcxGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridColumnHeaderViewInfo; var ADone: Boolean);
    procedure btvGCRighiCustomDrawPartBackground(Sender: TcxCustomGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxCustomGridCellViewInfo; var ADone: Boolean);
    procedure btvGCRighiCustomDrawGroupCell(Sender: TcxCustomGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridTableCellViewInfo; var ADone: Boolean);
    ...
    procedure SbGcVisPerArticoloMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure SbGcVisPerArticoloClick(Sender: TObject);
    procedure GridGCLinkCustomDrawFooterCell(Sender: TdxGridReportLink; ACanvas: TCanvas; AView: TcxGridTableView; ARecord: TcxCustomGridRecord;
      AColumn: TcxGridColumn; ALevel: Integer; AnItem: TdxReportCellString; var ADone: Boolean);
    procedure GridGCLinkCustomDrawCell(Sender: TdxGridReportLink; ACanvas: TCanvas; AView: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
      AColumn: TcxGridColumn; AnItem: TAbstractdxReportCellData; var ADone: Boolean);
    procedure GridGCLinkCustomDrawBandCell(Sender: TdxGridReportLink; ACanvas: TCanvas; AView: TcxGridBandedTableView; ABand: TcxGridBand;
      AnItem: TdxReportCellString; var ADone: Boolean);
    procedure btvGCRighiGC_RICARICOGetDataText(Sender: TcxCustomGridTableItem; ARecordIndex: Integer; var AText: String);
    procedure GridGCLinkCustomDrawHeaderCell(Sender: TdxGridReportLink; ACanvas: TCanvas; AView: TcxGridTableView; AColumn: TcxGridColumn;
      AnItem: TdxReportCellString; var ADone: Boolean);
    ...
    procedure dxPrinterCustomDrawPageFooter(Sender: TObject; AReportLink: TBasedxReportLink; ACanvas: TCanvas; APageIndex: Integer; var ARect: TRect;
      ANom, ADenom: Integer; var ADefaultDrawText, ADefaultDrawBackground: Boolean);
    procedure btvGCGIACENZA_QTAGetDataText(Sender: TcxCustomGridTableItem; ARecordIndex: Integer; var AText: String);
    procedure QryNewGCBeforeDelete(DataSet: TDataSet);
    procedure btvGCRighiKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
    ...
    procedure btvGCRighiEditing(Sender: TcxCustomGridTableView; AItem: TcxCustomGridTableItem; var AAllow: Boolean);
    procedure btvGCGIACENZA_QTAGetDisplayText(Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord; var AText: String);
    procedure btvGCRighiTRACK_PREVENTIVOGetDisplayText(Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord; var AText: String);
    ...
    procedure btvGCRighiFocusedRecordChanged(Sender: TcxCustomGridTableView; APrevFocusedRecord, AFocusedRecord: TcxCustomGridRecord;
      ANewItemRecordFocusingChanged: Boolean);
    procedure btvGCRighiTIPOLOGIAGetDataText(Sender: TcxCustomGridTableItem; ARecordIndex: Integer; var AText: String);
    procedure btvGCRighiGC_SEZIONEGetDataText(Sender: TcxCustomGridTableItem; ARecordIndex: Integer; var AText: String);
    procedure btvGCRighiEditValueChanged(Sender: TcxCustomGridTableView; AItem: TcxCustomGridTableItem);
    ...
    procedure GCCantieriApertiChiusiMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    ...
    procedure cxPageControlGCPageChanging(Sender: TObject; NewPage: TcxTabSheet; var AllowChange: Boolean);
    procedure btvGCDataControllerSummaryAfterSummary(ASender: TcxDataSummary);
    procedure btvGCTcxGridDBDataControllerTcxDataSummaryFooterSummaryItems18GetText(Sender: TcxDataSummaryItem; const AValue: Variant; AIsFooter: Boolean;
      var AText: string);
    procedure btvGCRIEP_QTACustomDrawCell(Sender: TcxCustomGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
    procedure btvGCRIEP_MARGINE_COMMESSACustomDrawCell(Sender: TcxCustomGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridTableDataCellViewInfo;
      var ADone: Boolean);
    procedure btvGCRIEP_COSTICustomDrawFooterCell(Sender: TcxGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridColumnHeaderViewInfo; var ADone: Boolean);
    procedure btvGCRIEP_MARGINE_COMMESSACustomDrawFooterCell(Sender: TcxGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridColumnHeaderViewInfo;
      var ADone: Boolean);
    procedure btvGCTcxGridDBDataControllerTcxDataSummaryFooterSummaryItems19G(Sender: TcxDataSummaryItem; const AValue: Variant; AIsFooter: Boolean;
      var AText: string);
    procedure btvGCRIEP_QTACustomDrawFooterCell(Sender: TcxGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridColumnHeaderViewInfo; var ADone: Boolean);
    procedure btvGCCOMMESSA_QTACustomDrawFooterCell(Sender: TcxGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridColumnHeaderViewInfo; var ADone: Boolean);
    procedure btvGCRighiDataControllerSummaryAfterSummary(ASender: TcxDataSummary);
    procedure btvGCCOMMESSA_RICARICOCustomDrawFooterCell(Sender: TcxGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridColumnHeaderViewInfo;
      var ADone: Boolean);
    ...
    procedure btvGCDataControllerSummaryFooterSummaryItemsSummary(ASender: TcxDataSummaryItems; Arguments: TcxSummaryEventArguments;
  ...
  private
    ...
    fParam_CodiceSoggetto, fParam_CodicePratica, fParam_DataPratica, fParam_SolocantieriAperti, fParam_DatiDiMagazzino, fParam_Agente1, fParam_Agente2,
      fParam_Agente3, fParam_Agente4, fParam_TipoRigo1, fParam_TipoRigo2, fParam_TipoRigo3, fParam_TipoRigo4, fParam_TipoRigo5, fParam_TipoRigo6,
      fParam_Sottocantiere1, fParam_Sottocantiere2, fParam_Sottocantiere3, fParam_CategCant1, fParam_CategCant2, fParam_CategCant3, fParam_CategCant4,
      fParam_CategCant5, fParam_CategCant6: String;
    ...
    procedure SetGC_Filter_Visible_DescrizioneArticolo(const Value: Boolean);
    ...
    function GetTipoDocPerEsportazioneRigoGCNew(DC: TcxCustomDataController; RI: Integer): String;
    function GetNumDocPerEsportazioneRigoGCNew(DC: TcxCustomDataController; RI: Integer): Integer;
    function GetRegDocPerEsportazioneRigoGCNew(DC: TcxCustomDataController; RI: Integer): String;
    ...
    function GetRagSocCliDocumento(TipoDoc: String; NumDoc: Integer; RegDoc: String; DataDoc: TDateTime): String;
    ...
    procedure SetGC_Filter_Visible_CantieriApertiChiusi(const Value: Boolean);
...
begin
  ...
  for i := 0 to btv.Bands.Count - 1 do
  begin
    ...
    for ii := 0 to CurrBand.ColumnCount - 1 do
    begin
...
begin
  ...
  begin
    ...
    begin
      if P.ValueExists(Sez, 'Visible') then
        CurrBand.Visible := P.ReadBool(Sez, 'Visible', True);
      if P.ValueExists(Sez, 'ColIndex') then
        CurrBand.Position.ColIndex := P.ReadInteger(Sez, 'ColIndex', 0);
      // Cicla per tutte le colonne della banda corrente e ne salva le proprietà che ci interessano
      for ii := 0 to CurrBand.ColumnCount - 1 do
      begin
        CurrColumn := CurrBand.Columns[ii];
        ...
        begin
          if P.ValueExists(Sez, 'Visible') then
            CurrColumn.Visible := P.ReadBool(Sez, 'Visible', True);
          if P.ValueExists(Sez, 'GroupIndex') then
            CurrColumn.GroupIndex := P.ReadInteger(Sez, 'GroupIndex', -1);
          if P.ValueExists(Sez, 'BandIndex') then
            CurrColumn.Position.BandIndex := P.ReadInteger(Sez, 'BandIndex', 0);
          if P.ValueExists(Sez, 'ColIndex') then
            CurrColumn.Position.ColIndex := P.ReadInteger(Sez, 'ColIndex', 0);
          ...
          if not btv.IsDetail then
          begin
            if P.ValueExists(Sez, 'SortIndex') then
              CurrColumn.SortIndex := P.ReadInteger(Sez, 'SortIndex', -1);
            if P.ValueExists(Sez, 'SortOrder') then
            begin
              CurrColumn.SortOrder := Low(CurrColumn.SortOrder);
              for iii := 1 to P.ReadInteger(Sez, 'SortOrder', -1) do
                CurrColumn.SortOrder := Succ(CurrColumn.SortOrder);
            end;
          end;
          if P.ValueExists(Sez, 'Width') then
            CurrColumn.Width := P.ReadInteger(Sez, 'Width', -1);
        end;
      end;
    end;
  end;
...
begin
  ...
  try
    ...
    if (Self.GC_Filter_Visible_CategCant1 or Self.GC_Filter_Visible_CategCant2 or Self.GC_Filter_Visible_CategCant3) then
    begin
      PanelFilterCategorieCantieri.Visible := True;
      PanelFilterCategorieCantieri.Height := 19;
    end;
    if (Self.GC_Filter_Visible_CategCant4 or Self.GC_Filter_Visible_CategCant5 or Self.GC_Filter_Visible_CategCant6) then
    begin
      PanelFilterCategorieCantieri.Visible := True;
...
begin
  ...
  begin
    ...
    if QryGCCOMMESSA_IMPORTOACQ.AsFloat <> 0 then
      QryGCCOMMESSA_RICARICO.Value := DM1.Arrotonda((100 * QryGCCOMMESSA_GUADAGNOIMPORTO.AsFloat / QryGCCOMMESSA_IMPORTOACQ.AsFloat), DM1.DecMicroPrz)
    else
  ...
  // GIACENZA
  if QryGCGIACENZA_QTA.AsFloat <> 0 then
  begin
    ...
    if QryGCGIACENZA_IMPORTOACQ.AsFloat <> 0 then
      QryGCGIACENZA_RICARICO.Value := DM1.Arrotonda((100 * QryGCGIACENZA_GUADAGNOIMPORTO.AsFloat / QryGCGIACENZA_IMPORTOACQ.AsFloat), DM1.DecMicroPrz)
    else
  ...
  // MONTATO
  if QryGCMONTATO_QTA.AsFloat <> 0 then
  begin
    ...
    if QryGCMONTATO_IMPORTOACQ.AsFloat <> 0 then
      QryGCMONTATO_RICARICO.Value := DM1.Arrotonda((100 * QryGCMONTATO_GUADAGNOIMPORTO.AsFloat / QryGCMONTATO_IMPORTOACQ.AsFloat), DM1.DecMicroPrz)
    else
  ...
  if QryGCGIACENZA_IMPORTOACQ.AsFloat <> 0 then
    QryGCRIEP_PERC_MARGINE_COMMESSA.Value := SimpleRoundTo(QryGCRIEP_MARGINE_COMMESSA.AsFloat * 100 / QryGCGIACENZA_IMPORTOACQ.AsFloat,
      DM1.DecimaliMarginiPercentuali * (-1))
  else
  ...
  if QryGCGIACENZA_IMPORTOACQ.AsFloat <> 0 then
    QryGCRIEP_PERC_MARGINE_FATTURATO.Value := SimpleRoundTo(QryGCRIEP_MARGINE_FATTURATO.AsFloat * 100 / QryGCGIACENZA_IMPORTOACQ.AsFloat,
      DM1.DecimaliMarginiPercentuali * (-1))
  else
  ...
  if QryGCGIACENZA_IMPORTOACQ.AsFloat <> 0 then
    QryGCRIEP_PERC_MARGINE_MONTATO.Value := SimpleRoundTo(QryGCRIEP_MARGINE_MONTATO.AsFloat * 100 / QryGCGIACENZA_IMPORTOACQ.AsFloat,
      DM1.DecimaliMarginiPercentuali * (-1))
  else
  ...
  if DM1.TableProgressiviMAG_ORDINATONELDISPONIBILE.AsBoolean then
    QryGCMAG_DISPONIBILE.Value := QryGCMAG_GIACENZA.AsFloat - QryGCMAG_IMPEGNATO.AsFloat + QryGCMAG_ORDINATO.AsFloat
  else
    QryGCMAG_DISPONIBILE.Value := QryGCMAG_GIACENZA.AsFloat - QryGCMAG_IMPEGNATO.AsFloat;
...
procedure TTabGCForm.btvGCCOMMESSA_QTACustomDrawFooterCell(Sender: TcxGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridColumnHeaderViewInfo;
  var ADone: Boolean);
var
...
procedure TTabGCForm.btvGCCOMMESSA_RICARICOCustomDrawFooterCell(Sender: TcxGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridColumnHeaderViewInfo;
  var ADone: Boolean);
begin
  inherited;
  // Anche se i valori delle colonne Qtà di solito non sono in grassetto
...
const
  Sez = 'SELETTORI';
begin
  if SbGcVisCommessa.Visible then
    SbGcVisCommessa.Down := P.ReadBool(Sez, SbGcVisCommessa.Name, (not GC_CantiereSelezionato))
  else
    SbGcVisCommessa.Down := False;
  if SbGcVisGiacenza.Visible then
    SbGcVisGiacenza.Down := P.ReadBool(Sez, SbGcVisGiacenza.Name, True)
  else
    SbGcVisGiacenza.Down := False;
  if SbGcVisRiepilogo.Visible then
    SbGcVisRiepilogo.Down := P.ReadBool(Sez, SbGcVisRiepilogo.Name, False)
  else
    SbGcVisRiepilogo.Down := False;
  if SbGcVisRiepilogoPerc.Visible then
    SbGcVisRiepilogoPerc.Down := P.ReadBool(Sez, SbGcVisRiepilogoPerc.Name, False)
  else
    SbGcVisRiepilogoPerc.Down := False;
  if SbGcVisMontato.Visible then
    SbGcVisMontato.Down := P.ReadBool(Sez, SbGcVisMontato.Name, False)
  else
    SbGcVisMontato.Down := False;
  if SbGcVisFatturato.Visible then
    SbGcVisFatturato.Down := P.ReadBool(Sez, SbGcVisFatturato.Name, (not GC_CantiereSelezionato))
  else
    SbGcVisFatturato.Down := False;
  if SbGcVisMagazzino.Visible then
    SbGcVisMagazzino.Down := P.ReadBool(Sez, SbGcVisMagazzino.Name, False)
  else
    SbGcVisMagazzino.Down := False;
  if SbGcVisSottocantieri.Visible then
    SbGcVisSottocantieri.Down := P.ReadBool(Sez, SbGcVisSottocantieri.Name, False)
  else
    SbGcVisSottocantieri.Down := False;
  if SbGcVisGruppi.Visible then
    SbGcVisGruppi.Down := P.ReadBool(Sez, SbGcVisGruppi.Name, False)
  else
    SbGcVisGruppi.Down := False;
  if SbGcVisDocumenti.Visible then
    SbGcVisDocumenti.Down := P.ReadBool(Sez, SbGcVisDocumenti.Name, False)
  else
    SbGcVisDocumenti.Down := False;
  if SbGcVisTrack.Visible then
    SbGcVisTrack.Down := P.ReadBool(Sez, SbGcVisTrack.Name, False)
  else
    SbGcVisTrack.Down := False;
  if SbGcVisCategCant.Visible then
    SbGcVisCategCant.Down := P.ReadBool(Sez, SbGcVisCategCant.Name, False)
  else
    SbGcVisCategCant.Down := False;

  if SbGcVisDaMontareCommessa.Visible then
    SbGcVisDaMontareCommessa.Down := P.ReadBool(Sez, SbGcVisDaMontareCommessa.Name, False)
  else
    SbGcVisDaMontareCommessa.Down := False;
  if SbGcVisDaMontareGiacenza.Visible then
    SbGcVisDaMontareGiacenza.Down := P.ReadBool(Sez, SbGcVisDaMontareGiacenza.Name, False)
  else
    SbGcVisDaMontareGiacenza.Down := False;

  if SbGcVisDaFatturareCommessa.Visible then
    SbGcVisDaFatturareCommessa.Down := P.ReadBool(Sez, SbGcVisDaFatturareCommessa.Name, (not GC_CantiereSelezionato))
  else
    SbGcVisDaFatturareCommessa.Down := False;
  if SbGcVisDaFatturareGiacenza.Visible then
    SbGcVisDaFatturareGiacenza.Down := P.ReadBool(Sez, SbGcVisDaFatturareGiacenza.Name, (not GC_CantiereSelezionato))
  else
    SbGcVisDaFatturareGiacenza.Down := False;
  if SbGcVisDaFatturareMontato.Visible then
    SbGcVisDaFatturareMontato.Down := P.ReadBool(Sez, SbGcVisDaFatturareMontato.Name, False)
  else
    SbGcVisDaFatturareMontato.Down := False;

  if SbGcVisQta.Visible then
    SbGcVisQta.Down := P.ReadBool(Sez, SbGcVisQta.Name, (GC_CantiereSelezionato))
  else
    SbGcVisQta.Down := False;
  if SbGcVisPrzUnitAcquisto.Visible then
    SbGcVisPrzUnitAcquisto.Down := P.ReadBool(Sez, SbGcVisPrzUnitAcquisto.Name, (GC_CantiereSelezionato))
  else
    SbGcVisPrzUnitAcquisto.Down := False;
  if SbGcVisImportiAcquisto.Visible then
    SbGcVisImportiAcquisto.Down := P.ReadBool(Sez, SbGcVisImportiAcquisto.Name, (GC_CantiereSelezionato))
  else
    SbGcVisImportiAcquisto.Down := False;
  if SbGcVisPrzUnitVendita.Visible then
    SbGcVisPrzUnitVendita.Down := P.ReadBool(Sez, SbGcVisPrzUnitVendita.Name, (GC_CantiereSelezionato))
  else
    SbGcVisPrzUnitVendita.Down := False;
  if SbGcVisImportiVendita.Visible then
    SbGcVisImportiVendita.Down := P.ReadBool(Sez, SbGcVisImportiVendita.Name, True)
  else
    SbGcVisImportiVendita.Down := False;
  if SbGcVisRicaricoPercent.Visible then
    SbGcVisRicaricoPercent.Down := P.ReadBool(Sez, SbGcVisRicaricoPercent.Name, (GC_CantiereSelezionato))
  else
    SbGcVisRicaricoPercent.Down := False;
  if SbGcVisRicaricoImporto.Visible then
    SbGcVisRicaricoImporto.Down := P.ReadBool(Sez, SbGcVisRicaricoImporto.Name, (GC_CantiereSelezionato))
  else
    SbGcVisRicaricoImporto.Down := False;

  if SbGcVisPerArticolo.Visible then
    SbGcVisPerArticolo.Down := P.ReadBool(Sez, SbGcVisPerArticolo.Name, (not GC_CantiereSelezionato))
  else
    SbGcVisPerArticolo.Down := False;
  if SbGcVisCronologicoGiorno.Visible then
    SbGcVisCronologicoGiorno.Down := P.ReadBool(Sez, SbGcVisCronologicoGiorno.Name, False)
  else
    SbGcVisCronologicoGiorno.Down := False;
  if SbGcVisCronologicoMese.Visible then
    SbGcVisCronologicoMese.Down := P.ReadBool(Sez, SbGcVisCronologicoMese.Name, False)
  else
    SbGcVisCronologicoMese.Down := False;
  if SbGcVisPerCantiere.Visible then
    SbGcVisPerCantiere.Down := P.ReadBool(Sez, SbGcVisPerCantiere.Name, False)
  else
    SbGcVisPerCantiere.Down := False;
end;
...
begin
  ...
  if (not VarIsNull(DC.Values[RI, btvGCRighiTRACK_DDT.Index])) and (DC.Values[RI, btvGCRighiTRACK_DDT.Index] <> 'n.c.') and
    (DC.Values[RI, btvGCRighiTRACK_DDT.Index] <> '') then
    Result := DM1.ExpDocToDocType(DC.Values[RI, btvGCRighiTRACK_DDT.Index])
    // Se il rigo è stato messo in una BOLLA_ENTR...
  else if (not VarIsNull(DC.Values[RI, btvGCRighiTRACK_BOLLA_ENTR.Index])) and (DC.Values[RI, btvGCRighiTRACK_BOLLA_ENTR.Index] <> 'n.c.') and
    (DC.Values[RI, btvGCRighiTRACK_BOLLA_ENTR.Index] <> '') then
    Result := DM1.ExpDocToDocType(DC.Values[RI, btvGCRighiTRACK_BOLLA_ENTR.Index])
    // Se il rigo è stato messo in una COMMESSA...
  else if (not VarIsNull(DC.Values[RI, btvGCRighiTRACK_COMMESSA.Index])) and (DC.Values[RI, btvGCRighiTRACK_COMMESSA.Index] <> 'n.c.') and
    (DC.Values[RI, btvGCRighiTRACK_COMMESSA.Index] <> '') then
    Result := DM1.ExpDocToDocType(DC.Values[RI, btvGCRighiTRACK_COMMESSA.Index])
    // Se il rigo è stato messo in un PREVENTIVO...
  else if (not VarIsNull(DC.Values[RI, btvGCRighiTRACK_PREVENTIVO.Index])) and (DC.Values[RI, btvGCRighiTRACK_PREVENTIVO.Index] <> 'n.c.') and
    (DC.Values[RI, btvGCRighiTRACK_PREVENTIVO.Index] <> '') then
    Result := DM1.ExpDocToDocType(DC.Values[RI, btvGCRighiTRACK_PREVENTIVO.Index])
    // Altrimenti usa i dati del documento originario
  else
    Result := DC.Values[RI, btvGCRighiTIPODOCUMENTO.Index];
end;
...
begin
  ...
  if (not VarIsNull(DC.Values[RI, btvGCRighiTRACK_DDT.Index])) and (DC.Values[RI, btvGCRighiTRACK_DDT.Index] <> 'n.c.') and
    (DC.Values[RI, btvGCRighiTRACK_DDT.Index] <> '') then
    Result := DM1.ExpDocToDocNum(DC.Values[RI, btvGCRighiTRACK_DDT.Index])
    // Se il rigo è stato messo in una BOLLA_ENTR...
  else if (not VarIsNull(DC.Values[RI, btvGCRighiTRACK_BOLLA_ENTR.Index])) and (DC.Values[RI, btvGCRighiTRACK_BOLLA_ENTR.Index] <> 'n.c.') and
    (DC.Values[RI, btvGCRighiTRACK_BOLLA_ENTR.Index] <> '') then
    Result := DM1.ExpDocToDocNum(DC.Values[RI, btvGCRighiTRACK_BOLLA_ENTR.Index])
    // Se il rigo è stato messo in una COMMESSA...
  else if (not VarIsNull(DC.Values[RI, btvGCRighiTRACK_COMMESSA.Index])) and (DC.Values[RI, btvGCRighiTRACK_COMMESSA.Index] <> 'n.c.') and
    (DC.Values[RI, btvGCRighiTRACK_COMMESSA.Index] <> '') then
    Result := DM1.ExpDocToDocNum(DC.Values[RI, btvGCRighiTRACK_COMMESSA.Index])
    // Se il rigo è stato messo in un PREVENTIVO...
  else if (not VarIsNull(DC.Values[RI, btvGCRighiTRACK_PREVENTIVO.Index])) and (DC.Values[RI, btvGCRighiTRACK_PREVENTIVO.Index] <> 'n.c.') and
    (DC.Values[RI, btvGCRighiTRACK_PREVENTIVO.Index] <> '') then
    Result := DM1.ExpDocToDocNum(DC.Values[RI, btvGCRighiTRACK_PREVENTIVO.Index])
    // Altrimenti usa i dati del documento originario
  else
    Result := DC.Values[RI, btvGCRighiNUMORDPREV.Index];
end;
...
begin
  ...
  if (not VarIsNull(DC.Values[RI, btvGCRighiTRACK_DDT.Index])) and (DC.Values[RI, btvGCRighiTRACK_DDT.Index] <> 'n.c.') and
    (DC.Values[RI, btvGCRighiTRACK_DDT.Index] <> '') then
    Result := DM1.ExpDocToDocReg(DC.Values[RI, btvGCRighiTRACK_DDT.Index])
    // Se il rigo è stato messo in una BOLLA_ENTR...
  else if (not VarIsNull(DC.Values[RI, btvGCRighiTRACK_BOLLA_ENTR.Index])) and (DC.Values[RI, btvGCRighiTRACK_BOLLA_ENTR.Index] <> 'n.c.') and
    (DC.Values[RI, btvGCRighiTRACK_BOLLA_ENTR.Index] <> '') then
    Result := DM1.ExpDocToDocReg(DC.Values[RI, btvGCRighiTRACK_BOLLA_ENTR.Index])
    // Se il rigo è stato messo in una COMMESSA...
  else if (not VarIsNull(DC.Values[RI, btvGCRighiTRACK_COMMESSA.Index])) and (DC.Values[RI, btvGCRighiTRACK_COMMESSA.Index] <> 'n.c.') and
    (DC.Values[RI, btvGCRighiTRACK_COMMESSA.Index] <> '') then
    Result := DM1.ExpDocToDocReg(DC.Values[RI, btvGCRighiTRACK_COMMESSA.Index])
    // Se il rigo è stato messo in un PREVENTIVO...
  else if (not VarIsNull(DC.Values[RI, btvGCRighiTRACK_PREVENTIVO.Index])) and (DC.Values[RI, btvGCRighiTRACK_PREVENTIVO.Index] <> 'n.c.') and
    (DC.Values[RI, btvGCRighiTRACK_PREVENTIVO.Index] <> '') then
    Result := DM1.ExpDocToDocReg(DC.Values[RI, btvGCRighiTRACK_PREVENTIVO.Index])
    // Altrimenti usa i dati del documento originario
  else
    Result := DC.Values[RI, btvGCRighiREGISTRO.Index];
end;
...
begin
  ...
  if (not VarIsNull(DC.Values[RI, btvGCRighiTRACK_DDT.Index])) and (DC.Values[RI, btvGCRighiTRACK_DDT.Index] <> 'n.c.') and
    (DC.Values[RI, btvGCRighiTRACK_DDT.Index] <> '') then
    Result := DM1.ExpDocToDocDate(DC.Values[RI, btvGCRighiTRACK_DDT.Index])
    // Se il rigo è stato messo in una BOLLA DI ENTRATA...
  else if (not VarIsNull(DC.Values[RI, btvGCRighiTRACK_BOLLA_ENTR.Index])) and (DC.Values[RI, btvGCRighiTRACK_BOLLA_ENTR.Index] <> 'n.c.') and
    (DC.Values[RI, btvGCRighiTRACK_BOLLA_ENTR.Index] <> '') then
    Result := DM1.ExpDocToDocDate(DC.Values[RI, btvGCRighiTRACK_BOLLA_ENTR.Index])
    // Se il rigo è stato messo in una COMMESSA...
  else if (not VarIsNull(DC.Values[RI, btvGCRighiTRACK_COMMESSA.Index])) and (DC.Values[RI, btvGCRighiTRACK_COMMESSA.Index] <> 'n.c.') and
    (DC.Values[RI, btvGCRighiTRACK_COMMESSA.Index] <> '') then
    Result := DM1.ExpDocToDocDate(DC.Values[RI, btvGCRighiTRACK_COMMESSA.Index])
    // Se il rigo è stato messo in un PREVENTIVO...
  else if (not VarIsNull(DC.Values[RI, btvGCRighiTRACK_PREVENTIVO.Index])) and (DC.Values[RI, btvGCRighiTRACK_PREVENTIVO.Index] <> 'n.c.') and
    (DC.Values[RI, btvGCRighiTRACK_PREVENTIVO.Index] <> '') then
    Result := DM1.ExpDocToDocDate(DC.Values[RI, btvGCRighiTRACK_PREVENTIVO.Index])
    // Altrimenti usa i dati del documento originario
  else
    Result := DC.Values[RI, btvGCRighiDATADOCUMENTO.Index];
end;
...
begin
  ...
  try
    try
      ...
      // ----------------------------------
      for i := 0 to btvGCRighi.Controller.SelectedRecordCount - 1 do
      begin
        // Se questo rigo non è un rigo di Grouping procede, altrimenti lo salta
        if btvGCRighi.Controller.SelectedRecords[i].IsData then
        begin
          ...
          if (FBachecaAccorpaAltreSpese and (ATipologiaRigo = 'Altre spese')) then
            SpeseExists := True
          else if (FBachecaAccorpaManodopera and (ATipologiaRigo = 'Manodopera')) then
          ...
          begin
            ...
            Qry.SQL.Clear;
            Qry.SQL.Add
              ('insert into tmprighi (STATION_ID, TipoDocumento, Registro, NumOrdPrev, DataDocumento, RagSocCli, ProgRigo, ProgRigo2, CodiceCliente, CodiceArticolo, CodiceArticoloStm, Pratica, DataPratica, DescPratica,');
            Qry.SQL.Add
  ...
  try
    ...
    begin
      ...
      begin
        ...
        if (not VarIsNull(DC.Values[RI, btvGCRighiGC_QTA.Index])) and (DC.Values[RI, btvGCRighiGC_QTA.Index] <> 0) and
          (DC.Values[RI, btvGCRighiTIPOLOGIA.Index] <> 'Materiali / Apparecchi') and (DC.Values[RI, btvGCRighiTIPOLOGIA.Index] <> 'Altre spese') then
        begin
    ...
    begin
      ...
      begin
        ...
        Qry.SQL.Clear;
        Qry.SQL.Add
          ('insert into tmprighi (STATION_ID, TipoDocumento, Registro, NumOrdPrev, DataDocumento, ProgRigo, ProgRigo2, CodiceCliente, CodiceArticolo, CodiceArticoloStm, Pratica,');
        Qry.SQL.Add
          ('CodiceIVA, DescrizioneIVA, AliquotaIVA, Descrizione, PrezzoUnitario, PrezzoUnitarioIVACompresa, QTA, ScontoRigo, ScontoRigo2, ScontoRigo3, UnitaDiMisura, PrezzoAcquistoArticolo,');
...
begin
  ...
  try
    ...
    Qry.SQL.Add('NULL,'); // Aliquota IVA
    Qry.SQL.Add
      ('''RIMBORSO SPESE VARIE   (In questa voce posso essere compresi tutti quei costi che non siano manodopera, materiali o apparecchi (es: noleggi di attrezzature, vitto, alloggio, pedaggi ecc.)'',');
    // Descrizione
    ...
    begin
      ...
      begin
        ...
        RI := btvGCRighi.Controller.SelectedRecords[i].RecordIndex;
        // Se la giacenza dell'articolo attuale  = 0 non lo esporta nemmeno
        if (DC.Values[RI, btvGCRighiTIPOLOGIA.Index] = 'Altre spese') then
        begin
          // Se il rigo è tra quelli selezionati, procede alla suo esportazione.
          Qry.SQL.Clear;
          Qry.SQL.Add
            ('insert into tmprighi (STATION_ID, TipoDocumento, Registro, NumOrdPrev, DataDocumento, ProgRigo, ProgRigo2, CodiceCliente, CodiceArticolo, Pratica,');
          Qry.SQL.Add
            ('CodiceIVA, DescrizioneIVA, AliquotaIVA, Descrizione, PrezzoUnitario, PrezzoUnitarioIVACompresa, QTA, ScontoRigo, ScontoRigo2, ScontoRigo3, UnitaDiMisura, PrezzoAcquistoArticolo,');
          Qry.SQL.Add('Margine, ImportoMargine, NoteRigo, MovMag, PrzUnitOpera, QtaOpera, CodiceMagazzino, MinutiPrevisti)');
          Qry.SQL.Add('values (');
...
begin
  ...
  if DM1.Messaggi('Esportazione Cantiere in Bacheca',
    'ATTENZIONE !!!'#13#13'L''esportazione in bacheca da una vista riepilogata non inserirà i riferimenti ai documenti.'#13#13#13'Continuare ugualmente?',
    'Suggerimento: Per evere anche i riferimenti ai documenti effettuare l''esportazione dalla vista non riepilogativa.', [mbYes, mbNo], 0, nil) <> mrYes then
    Exit;
  // Inizializzazione
  SpeseExists := False;
  ManodoperaExists := False;
  ...
  try
    try
      ...
      begin
        // Se questo rigo non è un rigo di Grouping procede, altrimenti lo salta
        if TV.Controller.SelectedRecords[i].IsData then
        begin
          // RI contiene l'indice del record da importare
          RI := TV.Controller.SelectedRecords[i].RecordIndex;
          // Se il rigo attuale fa parte della manodopera imposta il flag
          // che indica che c'è almeno un rigo di manodopera presente nel GC
          if (DC.Values[RI, btvGCTIPOLOGIA.Index] = 'Manodopera') then
            ManodoperaExists := True;
          // Se il rigo attuale fa parte delle spese varie imposta il flag
          // che indica che c'è almeno un rigo di spese varie presente nel GC
          if (DC.Values[RI, btvGCTIPOLOGIA.Index] = 'Altre spese') then
            SpeseExists := True;
          // Se la giacenza dell'articolo attuale  = 0 non lo esporta nemmeno
          if (not VarIsNull(DC.Values[RI, btvGCGIACENZA_QTA.Index])) and (DC.Values[RI, btvGCGIACENZA_QTA.Index] <> 0) and
            (DC.Values[RI, btvGCTIPOLOGIA.Index] <> 'Manodopera') and (DC.Values[RI, btvGCTIPOLOGIA.Index] <> 'Altre spese') then
          begin
            ...
            if (not VarIsNull(DC.Values[RI, btvGCDESCRIZIONE.Index])) and (Trim(DC.Values[RI, btvGCDESCRIZIONE.Index]) = 'VARIE') then
            begin
              Qry.SQL.Add('1,');
            end
            else
            ...
            begin
              ...
              begin
                // Se la giacenza dell'articolo attuale  = 0 non lo esporta nemmeno
                if (not VarIsNull(DC.Values[YY, btvGCRighiGC_QTA.Index])) and (DC.Values[YY, btvGCRighiGC_QTA.Index] <> 0) and
                  (DC.Values[YY, btvGCRighiTIPOLOGIA.Index] <> 'Manodopera') then
                begin
                  // Calcola gli importi da inserire poi nei righi esportati
...
begin
  ...
  try
    ...
    // Ora calcola il totale della manodopera
    // ----------------------------------
    for i := 0 to btvGC.Controller.SelectedRecordCount - 1 do
    begin
      // Se questo rigo non è un rigo di Grouping procede, altrimenti lo salta
      if btvGC.Controller.SelectedRecords[i].IsData then
      begin
        // RI contiene l'indice del record da importare
        ...
        // Se invece è un rigo da considerare aggiorna i totali
        if (not VarIsNull(DC.Values[RI, btvGCGIACENZA_QTA.Index])) and (DC.Values[RI, btvGCGIACENZA_QTA.Index] <> 0) and
          (DC.Values[RI, btvGCTIPOLOGIA.Index] <> 'Materiali / Apparecchi') and (DC.Values[RI, btvGCTIPOLOGIA.Index] <> 'Altre spese') then
        begin
          // Ricava l'indice del tipo di manodopera da aggiornare tra quele disponibili.
...
begin
  ...
  if CodArtOpera = DM1.Manodopera[0].Codice then
    Result := 0
  else if CodArtOpera = DM1.Manodopera[1].Codice then
    Result := 1
  else if CodArtOpera = DM1.Manodopera[2].Codice then
    Result := 2
  else if CodArtOpera = DM1.Manodopera[3].Codice then
    Result := 3
  else if CodArtOpera = DM1.Manodopera[4].Codice then
    Result := 4;
end;
...
begin
  ...
  case OI of
    0:
      Result := GcVisPrezzoManodopera1.Value;
    1:
      Result := GcVisPrezzoManodopera2.Value;
    2:
      Result := GcVisPrezzoManodopera3.Value;
    3:
      Result := GcVisPrezzoManodopera4.Value;
    4:
      Result := GcVisPrezzoManodopera5.Value;
  end;
end;
...
begin
  ...
  case OI of
    0:
      Result := GcVisCostoManodopera1.Value;
    1:
      Result := GcVisCostoManodopera2.Value;
    2:
      Result := GcVisCostoManodopera3.Value;
    3:
      Result := GcVisCostoManodopera4.Value;
    4:
      Result := GcVisCostoManodopera5.Value;
  end;
end;
...
procedure TTabGCForm.btvGCMAG_DAORDINAREGetDataText(Sender: TcxCustomGridTableItem; ARecordIndex: Integer; var AText: String);
begin
  inherited;
  // Se la qta da ordinare < 0 significa che non bisogna ordinare nulla
  if btvGC.DataController.Values[ARecordIndex, btvGCMAG_DAORDINARE.Index] <= 0 then
  begin
    AText := '- - -';
  end;
end;
...
procedure TTabGCForm.SbGcVisCommessaMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
begin
  ...
  try
    ...
    btvGCRIEP_PERC_MARGINE_FATTURATO.Visible := btvGCRIEP_PERC_MARGINE_FATTURATO.Position.Band.Visible and SbGcVisRicaricoPercent.Down and
      SbGcVisFatturato.Down;;
    ...
    // DATI DOCUMENTO
    btvGCRighiCODICEARTICOLOREALE.Visible := btvGCRighiCODICEARTICOLOREALE.Position.Band.Visible and
      (DM1.TableProgressiviDOCGESTARTFORNSECONDARI.AsString = 'T');
...
begin
  ...
  begin
    ...
    for i := 0 to Length(PrecBtvGCRighiGroupedColumn) - 1 do
    begin
  ...
  begin
    ...
    for i := 0 to btvGCRighi.GroupedColumnCount - 1 do
    begin
...
var
  i: Integer;
begin
  for i := (btv.GroupedColumnCount - 1) downto 0 do
  begin
...
var
  i: Integer;
begin
  for i := (btv.SortedItemCount - 1) downto 0 do
  begin
...
begin
  inherited;
  try
    if SbGcVisMemAdd.Down then
    begin
      StopSalvaVistaGCNelleMemorie;
      if DM1.Messaggi('Memorizza vista', 'Confermi di voler salvare la vista attuale in questa memoria?',
        'NB: La nuova vista sovrascriverà l''eventuale vista precedentemente memorizzata nella stessa memoria.', [mbYes, mbNo], 0, nil) <> mrYes then
        Exit;
    ...
    else if SbGcVisMemSetPredef.Down then
    begin
      StopSalvaVistaGCNelleMemorie;
      if DM1.Messaggi('Imposta memoria predefinita', 'Confermi di voler impostare la memoria come predefinita?', '', [mbYes, mbNo], 0, nil) <> mrYes then
        Exit;
...
begin
  try
    ...
    MemButton.Down := True;
    // Chiusura Query
    if QryGC.Active then
      QryGC.Close;
    if QryNewGC.Active then
      QryNewGC.Close;
...
begin
  ...
  if InputQuery('Nome Memoria', 'Quale titolo per questa memoria?', MemoryCaption) then
  begin
    // Controlla che la vista non sia nullo
    if Trim(MemoryCaption) = '' then
      raise Exception.Create('Titolo non valido.');
  end
  else
  begin
  ...
  if GC_CantiereSelezionato then
    NomeFile := 'GC_NEW_SEL_MEMORY_CAPT.INI'
  else
    NomeFile := 'GC_NEW_UNSEL_MEMORY_CAPT.INI';
...
begin
  ...
  try
    ...
    Q.Open;
    if not Q.Eof then
      Q.FieldByName('CONTENUTO').SaveToFile(DM1.ImpGridsDir + NomeFile);
    Q.Close;
  finally
    Q.Free;
  end;
...
begin
  ...
  try
    ...
    if GC_CantiereSelezionato then
      P.WriteString('GC', 'MemoriaPredefinita', RightStr(MemButton.Name, 1))
    else
      P.WriteString('GC', 'MemoriaPredefinita_Unsel', RightStr(MemButton.Name, 1));
    P.UpdateFile;
...
begin
  ...
  try
    ...
    if GC_CantiereSelezionato then
      MemNumber := P.ReadString('GC', 'MemoriaPredefinita', '1')
    Else
      MemNumber := P.ReadString('GC', 'MemoriaPredefinita_Unsel', '1');
    if Trim(MemNumber) = '' then
      MemNumber := '1';
    if MemNumber = '0' then
      MemNumber := '10';
...
begin
  ...
  try
    ...
    // il suffisso 'UNSEL' al nome del file per avere memorie separate nei due casi
    if GC_CantiereSelezionato then
      NomeFile := GridGC.Name + '___NEW___' + NomeVista + '.ini'
    else
      NomeFile := GridGC.Name + '___NEW_UNSEL___' + NomeVista + '.ini';
    ...
    try
      ...
      if not GC_CantiereSelezionato then
      begin
...
begin
  inherited;
  if SbGcVisMem1.Font.Size = 1 then
  begin
    SbGcVisMem1.Font.Size := 7;
    SbGcVisMem2.Font.Size := 7;
    SbGcVisMem3.Font.Size := 7;
  ...
  if TimerAddMemoryGC.Tag = 20 then
    StopSalvaVistaGCNelleMemorie;
end;

procedure TTabGCForm.SbGcVisMem1MouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
  // Facendo click con il pulsante DX deseleziona tutti i tipo di documento tranne
  // quello su cui si è fatto click e poi richiama la ricerca.
...
procedure TTabGCForm.SetDatiSez_Visible_ImportoCosto(const Value: Boolean);
begin
...
procedure TTabGCForm.SetDatiSez_Visible_ImportoVendita(const Value: Boolean);
begin
...
procedure TTabGCForm.SetDatiSez_Visible_PrzUnitCosto(const Value: Boolean);
begin
...
procedure TTabGCForm.SetDatiSez_Visible_PrzUnitVendita(const Value: Boolean);
begin
...
procedure TTabGCForm.SetGC_Col_Visible_TipologiaArticolo(const Value: Boolean);
begin
...
procedure TTabGCForm.SetGC_Filter_Visible_CodiceArticolo(const Value: Boolean);
begin
...
procedure TTabGCForm.SetGC_Filter_Visible_DescrizioneArticolo(const Value: Boolean);
begin
...
procedure TTabGCForm.SetGC_Filter_Visible_Tipologia(const Value: Boolean);
begin
...
procedure TTabGCForm.SetGC_Filter_Visible_TipoMovimento(const Value: Boolean);
begin
...
procedure TTabGCForm.SetGC_Filter_Visible_CantieriApertiChiusi(const Value: Boolean);
begin
...
procedure TTabGCForm.SetGC_Filter_Visible_Sottocantiere1(const Value: Boolean);
begin
...
procedure TTabGCForm.SetGC_Filter_Visible_Sottocantiere2(const Value: Boolean);
begin
...
procedure TTabGCForm.SetGC_Filter_Visible_Sottocantiere3(const Value: Boolean);
begin
...
begin
  ...
  if Value then
    GCVisLabelTipoRicaricoComeDaCommessa.Font.Color := $000063C6
  else
    GCVisLabelTipoRicaricoComeDaCommessa.Font.Color := clBtnShadow;
end;
...
procedure TTabGCForm.SetTipoVis_Visible_CronologicoGiorno(const Value: Boolean);
begin
...
procedure TTabGCForm.SetTipoVis_Visible_CronologicoMese(const Value: Boolean);
begin
...
procedure TTabGCForm.SetTipoVis_Visible_PerArticolo(const Value: Boolean);
begin
...
begin
  inherited;
  if PanelGCFiltri.Tag = 1 then
    CloseFilterPanel(PanelGCFiltri, SBGCFilterOpenClose)
  else
    OpenFilterPanel(PanelGCFiltri, SBGCFilterOpenClose);
end;
...
begin
  ...
  try
    ...
    if not GC_CantiereSelezionato then
      Qry.SQL.Add('WHERE TIPODOCUMENTO = ''Cantieri/Pratiche''');
...
procedure TTabGCForm.GCTipoMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
...
begin
  ...
  if Trim(GCCodiceGruppo1.Text) = '' then
  begin
...
begin
  inherited;
  // Se il codice gruppo è nullo disattiva la selezione del gruppo2, altrimenti la attiva
  if Trim(GCCodiceGruppo2.Text) = '' then
  begin
...
begin
  inherited;
  // Se il codice gruppo è nullo disattiva la selezione del gruppo2, altrimenti la attiva
  if Trim(GCCodiceGruppo3.Text) = '' then
  begin
...
begin
  inherited;
  // Se il codice gruppo è nullo disattiva la selezione del gruppo2, altrimenti la attiva
  if Trim(GCCodiceGruppo4.Text) = '' then
  begin
...
begin
  inherited;
  // Se il codice gruppo è nullo disattiva la selezione del gruppo2, altrimenti la attiva
  if Trim(GCCodiceGruppo5.Text) = '' then
  begin
...
procedure TTabGCForm.GCMesiTuttiMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
  // Facendo click con il pulsante DX deseleziona tutti i tipo di documento tranne
  // quello su cui si è fatto click e poi richiama la ricerca.
...
procedure TTabGCForm.GCMesiNessunoMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
  // Facendo click con il pulsante DX deseleziona tutti i tipo di documento tranne
  // quello su cui si è fatto click e poi richiama la ricerca.
...
procedure TTabGCForm.GCGenMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
  // Facendo click con il pulsante DX deseleziona tutti i tipo di documento tranne
  // quello su cui si è fatto click e poi richiama la ricerca.
...
begin
  ...
  if GridGC.ActiveView = btvGCRighi then
  begin
...
procedure TTabGCForm.ApriDocumento(var DocType, Registro: String; var DocNum: Integer; var DocDate: TDate);
var
...
begin
  ...
  if ClientiForm.PraticaCorrente = '' then
    GCMesiTuttiClick(Self);
  // Azzera la query
  if ClientiForm.RxSpeedButtonResetQuery.Tag = 1 then
    QryGC.Close;
end;
...
begin
  ...
  if Cronologica then
    QryNewGC.SQL.Add(' V.DATADOCUMENTO AS GRP_DATADOCUMENTO')
  else
    QryNewGC.SQL.Add(' CAST(NULL AS DATE) AS GRP_DATADOCUMENTO');
  ...
  if btvGCSOTTOCANTIERE1.GroupIndex <> -1 then
    QryNewGC.SQL.Add(' ,V.SOTTOCANTIERE1 AS GRP_SOTTOCANTIERE1')
  else
    QryNewGC.SQL.Add(' ,CAST(''TUTTI'' AS VARCHAR(20)) AS GRP_SOTTOCANTIERE1');
  if btvGCSOTTOCANTIERE2.GroupIndex <> -1 then
    QryNewGC.SQL.Add(' ,V.SOTTOCANTIERE2 AS GRP_SOTTOCANTIERE2')
  else
    QryNewGC.SQL.Add(' ,CAST(''TUTTI'' AS VARCHAR(20)) AS GRP_SOTTOCANTIERE2');
  if btvGCSOTTOCANTIERE3.GroupIndex <> -1 then
    QryNewGC.SQL.Add(' ,V.SOTTOCANTIERE3 AS GRP_SOTTOCANTIERE3')
  else
    QryNewGC.SQL.Add(' ,CAST(''TUTTI'' AS VARCHAR(20)) AS GRP_SOTTOCANTIERE3');
  if btvGCTIPO1.GroupIndex <> -1 then
    QryNewGC.SQL.Add(' ,V.TIPO1 AS GRP_TIPO1')
  else
    QryNewGC.SQL.Add(' ,CAST(''TUTTI'' AS VARCHAR(20)) AS GRP_TIPO1');
  if btvGCTIPO2.GroupIndex <> -1 then
    QryNewGC.SQL.Add(' ,V.TIPO2 AS GRP_TIPO2')
  else
    QryNewGC.SQL.Add(' ,CAST(''TUTTI'' AS VARCHAR(20)) AS GRP_TIPO2');
  if btvGCTIPO3.GroupIndex <> -1 then
    QryNewGC.SQL.Add(' ,V.TIPO3 AS GRP_TIPO3')
  else
    QryNewGC.SQL.Add(' ,CAST(''TUTTI'' AS VARCHAR(20)) AS GRP_TIPO3');
  if btvGCTIPO4.GroupIndex <> -1 then
    QryNewGC.SQL.Add(' ,V.TIPO4 AS GRP_TIPO4')
  else
    QryNewGC.SQL.Add(' ,CAST(''TUTTI'' AS VARCHAR(20)) AS GRP_TIPO4');
  if btvGCTIPO5.GroupIndex <> -1 then
    QryNewGC.SQL.Add(' ,V.TIPO5 AS GRP_TIPO5')
  else
    QryNewGC.SQL.Add(' ,CAST(''TUTTI'' AS VARCHAR(20)) AS GRP_TIPO5');
  if btvGCTIPO6.GroupIndex <> -1 then
    QryNewGC.SQL.Add(' ,V.TIPO6 AS GRP_TIPO6')
  else
    QryNewGC.SQL.Add(' ,CAST(''TUTTI'' AS VARCHAR(20)) AS GRP_TIPO6');
  if btvGCAGENTE1.GroupIndex <> -1 then
    QryNewGC.SQL.Add(' ,V.AGENTE  AS GRP_AGENTE1')
  else
    QryNewGC.SQL.Add(' ,CAST(''TUTTI'' AS VARCHAR(25)) AS GRP_AGENTE1');
  if btvGCAGENTE2.GroupIndex <> -1 then
    QryNewGC.SQL.Add(' ,V.AGENTE2 AS GRP_AGENTE2')
  else
    QryNewGC.SQL.Add(' ,CAST(''TUTTI'' AS VARCHAR(25)) AS GRP_AGENTE2');
  if btvGCAGENTE3.GroupIndex <> -1 then
    QryNewGC.SQL.Add(' ,V.AGENTE3 AS GRP_AGENTE3')
  else
    QryNewGC.SQL.Add(' ,CAST(''TUTTI'' AS VARCHAR(25)) AS GRP_AGENTE3');
  if btvGCAGENTE4.GroupIndex <> -1 then
    QryNewGC.SQL.Add(' ,V.AGENTE4 AS GRP_AGENTE4')
  else
    QryNewGC.SQL.Add(' ,CAST(''TUTTI'' AS VARCHAR(25)) AS GRP_AGENTE4');
  ...
  if SbGcVisGruppi.Down then
  begin
    QryNewGC.SQL.Add
      (' ,CAST((SELECT G.Descrizione FROM Gruppi G WHERE G.Codice1=A.CodiceGruppo1 AND G.Codice2=-1 AND G.Codice3=-1 AND G.Codice4=-1 AND G.Codice5=-1 AND G.Codice6=-1) || ''  ('' || A.CodiceGruppo1 || '')'' AS VARCHAR(150)) AS GRUPPO1');
    QryNewGC.SQL.Add
      (' ,CAST((SELECT G.Descrizione FROM Gruppi G WHERE G.Codice1=A.CodiceGruppo1 AND G.Codice2=A.CodiceGruppo2 AND G.Codice3=-1 AND G.Codice4=-1 AND G.Codice5=-1 AND G.Codice6=-1) || ''  ('' || A.CodiceGruppo2 || '')'' AS VARCHAR(150)) AS GRUPPO2');
    QryNewGC.SQL.Add
      (' ,CAST((SELECT G.Descrizione FROM Gruppi G WHERE G.Codice1=A.CodiceGruppo1 AND G.Codice2=A.CodiceGruppo2 AND G.Codice3=A.CodiceGruppo3 AND G.Codice4=-1 AND G.Codice5=-1 AND G.Codice6=-1) || ''  ('' || A.CodiceGruppo3 || '')'' AS VARCHAR(150)) AS GRUPPO3');
    QryNewGC.SQL.Add
      (' ,CAST((SELECT G.Descrizione FROM Gruppi G WHERE G.Codice1=A.CodiceGruppo1 AND G.Codice2=A.CodiceGruppo2 AND G.Codice3=A.CodiceGruppo3 AND G.Codice4=A.CodiceGruppo4 AND G.Codice5=-1 AND G.Codice6=-1) || ''  ('' || A.CodiceGruppo4 || '')''');
    QryNewGC.SQL.Add('     AS VARCHAR(150)) AS GRUPPO4');
    QryNewGC.SQL.Add
      (' ,CAST((SELECT G.Descrizione FROM Gruppi G WHERE G.Codice1=A.CodiceGruppo1 AND G.Codice2=A.CodiceGruppo2 AND G.Codice3=A.CodiceGruppo3 AND G.Codice4=A.CodiceGruppo4 AND G.Codice5=A.CodiceGruppo5 AND G.Codice6=-1) || ''  ('' || A.CodiceGruppo5 || '')''');
    QryNewGC.SQL.Add('     AS VARCHAR(150)) AS GRUPPO5');
    QryNewGC.SQL.Add
      (' ,CAST((SELECT G.Descrizione FROM Gruppi G WHERE G.Codice1=A.CodiceGruppo1 AND G.Codice2=A.CodiceGruppo2 AND G.Codice3=A.CodiceGruppo3 AND G.Codice4=A.CodiceGruppo4 AND G.Codice5=A.CodiceGruppo5 AND G.Codice6=A.CodiceGruppo6)');
  ...
  if not GC_IsVistaDettaglio then
    QryNewGC.SQL.Add('ORDER BY  1,2,3,4,5');
  ...
  if (GCRighiNew_SelectedSectionCount > 1) and (GC_IsVistaDettaglio) then
  begin
...
begin
  NumSez := 0;
  if SbGcVisCommessa.Down then
    Inc(NumSez);
  if SbGcVisGiacenza.Down then
    Inc(NumSez);
  if SbGcVisMontato.Down then
    Inc(NumSez);
  if SbGcVisFatturato.Down then
    Inc(NumSez);
  Result := NumSez;
end;
...
begin
  ...
  else if ClientiForm.ClienteCorrente <> '' then
  begin
  ...
  if (Self.GCCantieriApertiChiusi.Checked[0] and not Self.GCCantieriApertiChiusi.Checked[1] and not GC_CantiereSelezionato) then
    fParam_SolocantieriAperti := QuotedStr('T')
  else
    fParam_SolocantieriAperti := 'NULL';
  // Dati di magazzino dell'articolo
  if SbGcVisMagazzino.Down and not ForzaDatiDiMagazzinoDisabilitati then
    fParam_DatiDiMagazzino := QuotedStr('T')
  else
    fParam_DatiDiMagazzino := QuotedStr('F');

  // Agenti
  if GCAgente.Text <> '' then
    fParam_Agente1 := QuotedStr(GCAgente.Text)
  else
    fParam_Agente1 := 'NULL';
  if GCAgente2.Text <> '' then
    fParam_Agente2 := QuotedStr(GCAgente2.Text)
  else
    fParam_Agente2 := 'NULL';
  if GCAgente3.Text <> '' then
    fParam_Agente3 := QuotedStr(GCAgente3.Text)
  else
    fParam_Agente3 := 'NULL';
  if GCAgente4.Text <> '' then
    fParam_Agente4 := QuotedStr(GCAgente4.Text)
  else
    fParam_Agente4 := 'NULL';

  // Tipo righi
  if GCTipo1.Text <> '' then
    fParam_TipoRigo1 := QuotedStr(GCTipo1.Text)
  else
    fParam_TipoRigo1 := 'NULL';
  if GCTipo2.Text <> '' then
    fParam_TipoRigo2 := QuotedStr(GCTipo2.Text)
  else
    fParam_TipoRigo2 := 'NULL';
  if GCTipo3.Text <> '' then
    fParam_TipoRigo3 := QuotedStr(GCTipo3.Text)
  else
    fParam_TipoRigo3 := 'NULL';
  if GCTipo4.Text <> '' then
    fParam_TipoRigo4 := QuotedStr(GCTipo4.Text)
  else
    fParam_TipoRigo4 := 'NULL';
  if GCTipo5.Text <> '' then
    fParam_TipoRigo5 := QuotedStr(GCTipo5.Text)
  else
    fParam_TipoRigo5 := 'NULL';
  if GCTipo6.Text <> '' then
    fParam_TipoRigo6 := QuotedStr(GCTipo6.Text)
  else
    fParam_TipoRigo6 := 'NULL';

  // Sottocantieri
  if GCSottocantiere1.Text <> '' then
    fParam_Sottocantiere1 := QuotedStr(GCSottocantiere1.Text)
  else
    fParam_Sottocantiere1 := 'NULL';
  if GCSottocantiere2.Text <> '' then
    fParam_Sottocantiere2 := QuotedStr(GCSottocantiere2.Text)
  else
    fParam_Sottocantiere2 := 'NULL';
  if GCSottocantiere3.Text <> '' then
    fParam_Sottocantiere3 := QuotedStr(GCSottocantiere3.Text)
  else
    fParam_Sottocantiere3 := 'NULL';
  // Categorie cantieri
  if GCCategCant1.Text <> '' then
    fParam_CategCant1 := QuotedStr(GCCategCant1.Text)
  else
    fParam_CategCant1 := 'NULL';
  if GCCategCant2.Text <> '' then
    fParam_CategCant2 := QuotedStr(GCCategCant2.Text)
  else
    fParam_CategCant2 := 'NULL';
  if GCCategCant3.Text <> '' then
    fParam_CategCant3 := QuotedStr(GCCategCant3.Text)
  else
    fParam_CategCant3 := 'NULL';
  if GCCategCant4.Text <> '' then
    fParam_CategCant4 := QuotedStr(GCCategCant4.Text)
  else
    fParam_CategCant4 := 'NULL';
  if GCCategCant5.Text <> '' then
    fParam_CategCant5 := QuotedStr(GCCategCant5.Text)
  else
    fParam_CategCant5 := 'NULL';
  if GCCategCant6.Text <> '' then
    fParam_CategCant6 := QuotedStr(GCCategCant6.Text)
  else
    fParam_CategCant6 := 'NULL';
  // Costruisce il risultato da restituire
  Result := fParam_CodiceSoggetto + ',' + fParam_CodicePratica + ',' + fParam_DataPratica + ',' + fParam_SolocantieriAperti + ',' + fParam_DatiDiMagazzino + ','
    + fParam_Sottocantiere1 + ',' + fParam_Sottocantiere2 + ',' + fParam_Sottocantiere3 + ',' + fParam_CategCant1 + ',' + fParam_CategCant2 + ',' +
    fParam_CategCant3 + ',' + fParam_CategCant4 + ',' + fParam_CategCant5 + ',' + fParam_CategCant6 + ',' + fParam_Agente1 + ',' + fParam_Agente2 + ',' +
    fParam_Agente3 + ',' + fParam_Agente4 + ',' + fParam_TipoRigo1 + ',' + fParam_TipoRigo2 + ',' + fParam_TipoRigo3 + ',' + fParam_TipoRigo4 + ',' +
    fParam_TipoRigo5 + ',' + fParam_TipoRigo6;
end;
...
begin
  ...
  if Magazzino then
  begin
    if DM1.Messaggi('Levante - Giornale di Cantiere',
      'ATTENZIONE !!!'#13#13'Quando la sezione dei dati di magazzino è attiva l''esecuzione dell''interrogazione potrebbe essere molto lenta.'#13#13'Potrebbero essere necessari diversi minuti.'#13#13'Proseguire?',
  ...
  if (not GCCheckListBoxSegnoOperazione.Checked[0]) and (not GCCheckListBoxSegnoOperazione.Checked[1]) and (not GCCheckListBoxSegnoOperazione.Checked[2]) and
    (not GCCheckListBoxSegnoOperazione.Checked[3]) and (not GCCheckListBoxSegnoOperazione.Checked[4]) then
  begin
    GCCheckListBoxSegnoOperazione.Checked[0] := True;
    GCCheckListBoxSegnoOperazione.Checked[1] := True;
    GCCheckListBoxSegnoOperazione.Checked[2] := True;
  ...
  if (not GCCantieriApertiChiusi.Checked[0]) and (not GCCantieriApertiChiusi.Checked[1]) and (not GCCantieriApertiChiusi.Checked[2]) then
  begin
    GCCantieriApertiChiusi.Checked[0] := True;
    GCCantieriApertiChiusi.Checked[1] := False;
  end;
  if (not GCTipo.Checked[0]) and (not GCTipo.Checked[1]) and (not GCTipo.Checked[2]) then
  begin
    GCTipo.Checked[0] := True;
    GCTipo.Checked[1] := True;
    GCTipo.Checked[2] := True;
  ...
  try
    try
      ...
      begin
        ...
        QryGC.SQL.Add('    CASE');
        QryGC.SQL.Add
          ('      WHEN (V.SEGNOOPERAZIONECANTIERE = ''F'' AND TIPODOCUMENTO <> ''Nota_accre'') THEN ''- Fattura n° '' || V.NUMORDPREV || V.REGISTRO || '' del '' || V.DataDocumento');
        QryGC.SQL.Add
          ('      WHEN (V.SEGNOOPERAZIONECANTIERE = ''F'' AND TIPODOCUMENTO =  ''Nota_accre'') THEN ''- Nota di credito n° '' || V.NUMORDPREV || V.REGISTRO || '' del '' || V.DataDocumento');
      ...
      begin
        ...
        begin
          QryGC.SQL.Add(', CASE ');
          QryGC.SQL.Add('    WHEN (V.GC_SEZIONE = ''Commessa'') THEN CAST(''' + FormatDateTime('mm/dd/yyyy', StrToDate(Trim(GCDal.EditText))) +
            ''' AS TIMESTAMP)');
      ...
      begin
        ...
        QryGC.SQL.Add
          ('  (SELECT M.CODICEARTICOLO, SUM(M.GIACENZA) AS MAG_GIACENZA, SUM(M.ORDINATO) AS MAG_ORDINATO, SUM(M.IMPEGNATO) AS MAG_IMPEGNATO FROM MAG_ART AS M GROUP BY M.CODICEARTICOLO)');
      ...
      // vengano ignorati
      if GCSoloRighiNoZero.Checked[0] then
        DM1.AddSQL(QryGC, 'AND',
          '((V.GC_COSTONETTOIMPORTO<>0 AND V.GC_COSTONETTOIMPORTO IS NOT NULL) OR (V.GC_PRZVENDIMPORTO<>0 AND V.GC_PRZVENDIMPORTO IS NOT NULL))');

      // Se specificato ricerca per COdiceArticolo
      if GCCodiceArticolo.Text <> '' then
        DM1.AddSQL(QryGC, 'AND', 'V.CodiceArticolo LIKE ''' + Trim(GCCodiceArticolo.Text) + '''');
      // Se è specificato la ricerca per testo (Descrizione, note ecc)
      if GCDescrizione.Text <> '' then
      begin
        DM1.AddSQL(QryGC, 'AND', '(');
      ...
      if GCMarca.Text <> '' then
        DM1.AddSQL(QryGC, 'AND', 'UPPER(A.Marca) = UPPER(''' + Trim(GCMarca.Text) + ''')');

      // Se specificato ricerca per RDA
      if GCRDA.Text <> '' then
        DM1.AddSQL(QryGC, 'AND', 'UPPER(V.RDA) = UPPER(''' + Trim(GCRDA.Text) + ''')');
      ...
      if GCAgente.Text <> '' then
        DM1.AddSQL(QryGC, 'AND', 'V.Agente  = ''' + Trim(GCAgente.Text) + '''');
      if GCAgente2.Text <> '' then
        DM1.AddSQL(QryGC, 'AND', 'V.Agente2 = ''' + Trim(GCAgente2.Text) + '''');
      if GCAgente3.Text <> '' then
        DM1.AddSQL(QryGC, 'AND', 'V.Agente3 = ''' + Trim(GCAgente3.Text) + '''');
      if GCAgente4.Text <> '' then
        DM1.AddSQL(QryGC, 'AND', 'V.Agente4 = ''' + Trim(GCAgente4.Text) + '''');

      // Filtra in base ai gruppi/sottogruppi selezionati
      if GCCodiceGruppo1.Text <> '' then
        DM1.AddSQL(QryGC, 'AND', 'A.CODICEGRUPPO1 = ' + GCCodiceGruppo1.Text);
      if GCCodiceGruppo2.Text <> '' then
        DM1.AddSQL(QryGC, 'AND', 'A.CODICEGRUPPO2 = ' + GCCodiceGruppo2.Text);
      if GCCodiceGruppo3.Text <> '' then
        DM1.AddSQL(QryGC, 'AND', 'A.CODICEGRUPPO3 = ' + GCCodiceGruppo3.Text);
      if GCCodiceGruppo4.Text <> '' then
        DM1.AddSQL(QryGC, 'AND', 'A.CODICEGRUPPO4 = ' + GCCodiceGruppo4.Text);
      if GCCodiceGruppo5.Text <> '' then
        DM1.AddSQL(QryGC, 'AND', 'A.CODICEGRUPPO5 = ' + GCCodiceGruppo5.Text);
      if GCCodiceGruppo6.Text <> '' then
        DM1.AddSQL(QryGC, 'AND', 'A.CODICEGRUPPO6 = ' + GCCodiceGruppo6.Text);
      // Filtra in base alla tipologia
      // NB: Filtro disabilitato se siamo fuori dal cantiere selezionato
      if GC_CantiereSelezionato then
      begin
        if not GCTipo.Checked[0] then
          QryGC.SQL.Add('AND V.TIPOLOGIA <> ''Materiali / Apparecchi''');
        if not GCTipo.Checked[1] then
          QryGC.SQL.Add('AND V.TIPOLOGIA <> ''Manodopera''');
        if not GCTipo.Checked[2] then
          QryGC.SQL.Add('AND V.TIPOLOGIA <> ''Altre spese''');
      end;
      // Filtra in base ai tipi di movimentazione selesionata
      if not GCCheckListBoxSegnoOperazione.Checked[0] then
        QryGC.SQL.Add('AND V.SEGNOOPERAZIONECANTIERE <> ''C''');
      if not GCCheckListBoxSegnoOperazione.Checked[1] then
        QryGC.SQL.Add('AND V.SEGNOOPERAZIONECANTIERE <> ''+''');
      if not GCCheckListBoxSegnoOperazione.Checked[2] then
        QryGC.SQL.Add('AND V.SEGNOOPERAZIONECANTIERE <> ''-''');
      if not GCCheckListBoxSegnoOperazione.Checked[3] then
        QryGC.SQL.Add('AND V.SEGNOOPERAZIONECANTIERE <> ''M''');
      if not GCCheckListBoxSegnoOperazione.Checked[4] then
        QryGC.SQL.Add('AND V.SEGNOOPERAZIONECANTIERE <> ''F''');
      ...
      if Trim(FilterGCTrova.Text) <> '' then
      begin
        DM1.AddSQL(QryGC, 'AND', '(');
      ...
      if GC_IsVistaDettaglio then
      begin
        if not SbGcVisCommessa.Down then
          QryGC.SQL.Add('AND V.GC_SEZIONE <> ''Commessa''');
        if not SbGcVisGiacenza.Down then
          QryGC.SQL.Add('AND V.GC_SEZIONE <> ''Giacenza''');
        if not SbGcVisMontato.Down then
          QryGC.SQL.Add('AND V.GC_SEZIONE <> ''Montato''');
        if not SbGcVisFatturato.Down then
          QryGC.SQL.Add('AND V.GC_SEZIONE <> ''Fatturato''');
      end;
      ...
      begin
        if GCCategCant1.Text <> '' then
          QryGC.SQL.Add('AND V.CATEGCANT1 = ''' + GCCategCant1.Text + '''');
        if GCCategCant2.Text <> '' then
          QryGC.SQL.Add('AND V.CATEGCANT2 = ''' + GCCategCant2.Text + '''');
        if GCCategCant3.Text <> '' then
          QryGC.SQL.Add('AND V.CATEGCANT3 = ''' + GCCategCant3.Text + '''');
        if GCCategCant4.Text <> '' then
          QryGC.SQL.Add('AND V.CATEGCANT4 = ''' + GCCategCant4.Text + '''');
        if GCCategCant5.Text <> '' then
          QryGC.SQL.Add('AND V.CATEGCANT5 = ''' + GCCategCant5.Text + '''');
        if GCCategCant6.Text <> '' then
          QryGC.SQL.Add('AND V.CATEGCANT6 = ''' + GCCategCant6.Text + '''');
      end;
      ...
      begin
        ...
        QryGC.SQL.Add
          ('  A.CodiceGruppo1, A.CodiceGruppo2, A.CodiceGruppo3, A.CodiceGruppo4, A.CodiceGruppo5, A.CodiceGruppo6, RIFPRATICA, RIFSOGGPRAT, CATEGCANT1, CATEGCANT2, CATEGCANT3, CATEGCANT4, CATEGCANT5, CATEGCANT6'
          + GroupByStr);
      end
      else
      begin
        QryGC.SQL.Add
          ('GROUP BY CODICEARTICOLO, DESCRIZIONE, UNITADIMISURA, MAG_ULTIMOPREZZOACQUISTO, TIPOLOGIA, RIFPRATICA, RIFSOGGPRAT, CATEGCANT1, CATEGCANT2, CATEGCANT3, CATEGCANT4, CATEGCANT5, CATEGCANT6'
          + GroupByStr);
      end;
      ...
      begin
        ...
        begin
          ...
          if (btvGCDATADOCUMENTO.GroupIndex = -1) then
            btvGCDATADOCUMENTO.GroupIndex := 0;
          btvGCDATADOCUMENTO.Visible := False;
          // Se non è già raggruppato per TIPOLOGIA lo raggruppa come 2° livello
          if (btvGCTIPOLOGIA.GroupIndex = -1) and (Self.GC_Col_Visible_TipologiaArticolo) then
            btvGCTIPOLOGIA.GroupIndex := 1;
          btvGCTIPOLOGIA.Visible := False;
          // Imposta il tipo di raggruppamento per date
          if SbGcVisCronologicoGiorno.Down then
            btvGCDATADOCUMENTO.DateTimeGrouping := dtgByDate
          else if SbGcVisCronologicoMese.Down then
            btvGCDATADOCUMENTO.DateTimeGrouping := dtgByMonth
          else
        ...
        begin
          ...
          if (btvGCRIFPRATICA.GroupIndex = -1) then
            btvGCRIFPRATICA.GroupIndex := 0;
...
begin
  ...
  try
    ...
    if not Q.Eof then
    begin
      if not Q.FieldByName('TIPORICARICO').IsNull then
        GcVisTipoRicarico.ItemIndex := Q.FieldByName('TIPORICARICO').AsInteger;
      if not Q.FieldByName('TIPOCOSTO').IsNull then
        GCVisTipoCosto.ItemIndex := Q.FieldByName('TIPOCOSTO').AsInteger;
      if not Q.FieldByName('RICARICOPERC').IsNull then
        GcVisRicaricoPerc.Value := Q.FieldByName('RICARICOPERC').AsFloat;
      if not Q.FieldByName('LISTINO').IsNull then
        GcVisListino.Text := Q.FieldByName('LISTINO').AsString;
      ...
      if not Q.FieldByName('PRZUNITOPERA1_1').IsNull then
        GcVisPrezzoManodopera1.Value := Q.FieldByName('PRZUNITOPERA1_1').AsFloat;
      if not Q.FieldByName('PRZUNITOPERA1_2').IsNull then
        GcVisPrezzoManodopera2.Value := Q.FieldByName('PRZUNITOPERA1_2').AsFloat;
      if not Q.FieldByName('PRZUNITOPERA1_3').IsNull then
        GcVisPrezzoManodopera3.Value := Q.FieldByName('PRZUNITOPERA1_3').AsFloat;
      if not Q.FieldByName('PRZUNITOPERA1_4').IsNull then
        GcVisPrezzoManodopera4.Value := Q.FieldByName('PRZUNITOPERA1_4').AsFloat;
      if not Q.FieldByName('PRZUNITOPERA1_5').IsNull then
        GcVisPrezzoManodopera5.Value := Q.FieldByName('PRZUNITOPERA1_5').AsFloat;

      if not Q.FieldByName('COSTOUNITOPERA1_1').IsNull then
        GcVisCostoManodopera1.Value := Q.FieldByName('COSTOUNITOPERA1_1').AsFloat;
      if not Q.FieldByName('COSTOUNITOPERA1_2').IsNull then
        GcVisCostoManodopera2.Value := Q.FieldByName('COSTOUNITOPERA1_2').AsFloat;
      if not Q.FieldByName('COSTOUNITOPERA1_3').IsNull then
        GcVisCostoManodopera3.Value := Q.FieldByName('COSTOUNITOPERA1_3').AsFloat;
      if not Q.FieldByName('COSTOUNITOPERA1_4').IsNull then
        GcVisCostoManodopera4.Value := Q.FieldByName('COSTOUNITOPERA1_4').AsFloat;
      if not Q.FieldByName('COSTOUNITOPERA1_5').IsNull then
        GcVisCostoManodopera5.Value := Q.FieldByName('COSTOUNITOPERA1_5').AsFloat;
    end;
  finally
    Q.Free
  end;
...
begin
  ...
  try
    ...
    if GCVisTipoRicaricoComeDaCommessa.Checked then
      Q.SQL.Add(' TIPORICARICOCOMEDACOMMESSA = ''T'',')
    else
      Q.SQL.Add(' TIPORICARICOCOMEDACOMMESSA = ''F'',');

    if GCVisAccorpaManodoperaInBacheca.Checked then
      Q.SQL.Add(' AccorpaOperaInBacheca = ''T'',')
    else
      Q.SQL.Add(' AccorpaOperaInBacheca = ''F'',');
...
begin
  ...
  if (ClientiForm.PraticaCorrente <> '') then
    VisualizzazioneConCantiereSelezionato
  else
    VisualizzazioneConCantiereNonSelezionato;
  ...
  if (not QryGC.Active) and (not QryGC.Active) then
  begin
    ClientiForm.RxSpeedButtonResetQueryClick(ClientiForm.RxSpeedButtonResetQuery);
    if DM1.GoAutoquery(IDX_AUTOQUERY_GC) then
    begin
      ClientiForm.RxSpeedButtonTrovaClick(Self);
    end;
  end;
...
begin
  ...
  try
    ...
    for i := (CurrentView.Controller.SelectedRecordCount - 1) downto 0 do
    begin
      CurrentView.Controller.SelectedRecords[i].Selected := False;
    end;
    // Poi seleziona tutti i righi evitando i righi di gruppo
    for i := 0 to (CurrentView.ViewData.RecordCount - 1) do
    begin
      if CurrentView.ViewData.Records[i].IsData then
        CurrentView.ViewData.Records[i].Selected := True;
    end;
  finally
    DM1.CloseWait;
    if not Updating then
...
begin
  ...
  Updating := GridGC.UpdateLocked;
  if not Updating and Tutti then
    SBGCExpandClick(SBGCExpand);
  if not Updating then
    GridGC.BeginUpdate;
  try
...
begin
  if DM1.Messaggi('Creazione automatica documento', 'Proseguire con la creazione automatica del documento?', '', [mbYes, mbNo], 0, nil) <> mrYes then
    Exit;

  // Se la bacheca non è vuota avverte l'utente che deve esserlo e poi esce
  if MainForm.ListViewExpDoc.Items.Count <> 0 then
  begin
    DM1.Messaggi('Creazione automatica documento',
      'ATTENZIONE !!!'#13#13'Quando si avvia la generazione automatica di un documento la bacheca deve essere vuota.'#13#13'L''operazione è stata annullata!',
      '', [mbOk], 0, nil);
    Exit;
  end;
  ...
  try
    ...
    DM1.NuovoDocFisc(TipoDoc, '', StrToIntDef(ClientiForm.ClienteCorrente, 0), StrToIntDef(ClientiForm.PraticaCorrente, 0), ClientiForm.DataPraticaCorrente, 1,
      0, False, False);
...
procedure TTabGCForm.cxPageControlGCPageChanging(Sender: TObject; NewPage: TcxTabSheet; var AllowChange: Boolean);
var
  LChart: TChartFrame;
begin
  inherited;
...
begin
  ...
  try
    ...
    // Se specificato ricerca per COdiceArticolo
    if GCCodiceArticolo.Text <> '' then
      QryGCAda.SQL.Add('AND R.CodiceArticolo = ''' + Trim(GCCodiceArticolo.Text) + '''');
    // Se specificato lo sttato del documento
    if GCSoloStato.Text <> '' then
      QryGCAda.SQL.Add('AND T.StatoDescrizione = ''' + Trim(GCSoloStato.Text) + '''');
    // Filtra in base ai tipi di movimentazione selesionata
    DM1.AddSQL(QryGCAda, 'AND', '(');
    if GCCheckListBoxSegnoOperazione.Checked[0] then
      DM1.AddSQL(QryGCAda, '', 'R.SEGNOOPERAZIONECANTIERE = ''C'' OR');
    if GCCheckListBoxSegnoOperazione.Checked[1] then
      DM1.AddSQL(QryGCAda, '', 'R.SEGNOOPERAZIONECANTIERE = ''+'' OR');
    if GCCheckListBoxSegnoOperazione.Checked[2] then
      DM1.AddSQL(QryGCAda, '', 'R.SEGNOOPERAZIONECANTIERE = ''-'' OR');
    if GCCheckListBoxSegnoOperazione.Checked[3] then
      DM1.AddSQL(QryGCAda, '', 'R.SEGNOOPERAZIONECANTIERE = ''M'' OR');
    if GCCheckListBoxSegnoOperazione.Checked[4] then
      DM1.AddSQL(QryGCAda, '', 'R.SEGNOOPERAZIONECANTIERE = ''='' OR R.SEGNOOPERAZIONECANTIERE IS NULL OR R.SEGNOOPERAZIONECANTIERE = '''' OR');
    QryGCAda.SQL[QryGCAda.SQL.Count - 1] := DM1.StrLeft(QryGCAda.SQL[QryGCAda.SQL.Count - 1], Length(QryGCAda.SQL[QryGCAda.SQL.Count - 1]) - 3);
    // Elimina l'ultimo OR
    QryGCAda.SQL.Add(')');
    // Se specificate ricerca per intervallo di date
    if DM1.ControllaDataStr(GCDal.EditText) then
      DM1.AddSQL(QryGCAda, 'AND', 'R.DataDocumento >= ''' + FormatDateTime('mm/dd/yyyy', StrToDate(Trim(GCDal.EditText))) + '''');
    if DM1.ControllaDataStr(GCAl.EditText) then
      DM1.AddSQL(QryGCAda, 'AND', 'R.DataDocumento <= ''' + FormatDateTime('mm/dd/yyyy', StrToDate(Trim(GCAl.EditText))) + '''');
    // Attiva la query
    QryGCAda.Open;
  finally
    DM1.CloseWait;
...
begin
  ...
  try
    ...
    Q.SQL.Add('SELECT MAX(PROGRIGO) FROM GC_BASE_RIGHI_NEW WHERE TIPODOCUMENTO=''Giornale_cantiere'' AND NUMORDPREV=' + ClientiForm.PraticaCorrente +
      ' AND PRATICA=' + ClientiForm.PraticaCorrente + ' AND DATAPRATICA1 =''' + ClientiForm.DataPraticaCorrenteSQL + '''');
    ...
    try
      ...
      begin
        ...
        try
          ...
          if QryNewGC.State <> dsBrowse then
            QryNewGC.Post;
          // Commit
          DM1.DBAzienda.CommitRetaining;
          // Riabilita il main menù
  ...
  try
    ...
    try
      ...
      if DM1.LunghezzaMaxDescrizioneArticolo <> 0 then
        DC.DataSet.FieldByName('DESCRIZIONE').AsString := LeftStr(Qry.FieldByName('Descrizione').AsString, DM1.LunghezzaMaxDescrizioneArticolo)
      else
        DC.DataSet.FieldByName('DESCRIZIONE').AsString := Qry.FieldByName('Descrizione').AsString;
...
begin
  ...
  try
    ...
    Qry.SQL.Add
      ('SELECT DISTINCT(A.CodiceArticolo), A.Descrizione, A.Descrizione2, A.Descrizione3, A.Descrizione4, A.Descrizione5, A.UnitaDiMisura, A.UltimoPrzAcquisto,');
    Qry.SQL.Add
    ...
    begin
      ...
      begin
        if TmpStr <> '' then
          TmpStr := TmpStr + ' OR ';
        TmpStr := TmpStr + 'EXISTS (SELECT LF.CODICEARTICOLO FROM LISTFORN LF WHERE LF.CODICEARTICOLO = A.CODICEARTICOLO AND LF.CODICEARTICOLOFORNITORE LIKE '''
          + CodTutti + ''')';
      end;
    end
    else
    begin
      if CodArt <> '' then
        TmpStr := TmpStr + 'CodiceArticolo = ''' + CodArt + ''' OR ';
      if CodBarre <> '' then
        TmpStr := TmpStr + 'BarCode = ''' + CodBarre + ''' OR ';
      if CodForn <> '' then
        TmpStr := TmpStr + 'CodiceFornitore = ''' + CodForn + ''' OR ';
      TmpStr := DM1.StrLeft(TmpStr, Length(TmpStr) - 4); // Elimina l'ultimo OR
    end;
    // Aggiunge le condizioni rilevate
    if TmpStr <> '' then
      Qry.SQL.Add('WHERE (' + TmpStr + ')');
  ...
  try
    ...
    begin
      ...
      try
        ...
        DC.DataSet.FieldByName('CODICEMAGAZZINO').AsInteger := CodDip;
        // Il codice dipendente lo parcheggio nel codice magazzino perchè è un intero anche lui e senza fare un campo apposito.
        ...
        DC.DataSet.FieldByName('CODICEARTICOLO').AsString := 'Opera - ' + IntToStr(CodDip);
        // NB: Solo per farlo vedere subito sul rigo appena inserito in quanto è un campo calcolato
        ...
        if not Qry.FieldByName('COSTOORARIO').IsNull then
          DC.DataSet.FieldByName('GC_COSTONETTOUNITARIO').AsCurrency := Qry.FieldByName('COSTOORARIO').AsCurrency;

        // Impostazione del prezzo di vendita
        case Qry.FieldByName('OPERAINDEX').AsInteger of
          0:
            DC.DataSet.FieldByName('GC_PRZVEND').AsCurrency := GcVisPrezzoManodopera1.Value;
          1:
            DC.DataSet.FieldByName('GC_PRZVEND').AsCurrency := GcVisPrezzoManodopera2.Value;
          2:
            DC.DataSet.FieldByName('GC_PRZVEND').AsCurrency := GcVisPrezzoManodopera3.Value;
          3:
            DC.DataSet.FieldByName('GC_PRZVEND').AsCurrency := GcVisPrezzoManodopera4.Value;
          4:
            DC.DataSet.FieldByName('GC_PRZVEND').AsCurrency := GcVisPrezzoManodopera5.Value;
        end;

        // Se è abilitato, richiede la Qtà di ore da inserire
        // if DM1.RichiediQta then DM1.ChiediOreManodopera(CodDip,
        DM1.ChiediOreManodopera(CodDip, Tmp, DC.DataSet.FieldByName('GC_QTA'), DC.DataSet.FieldByName('NOTERIGO'));
        // Conferma il dato e si posiziona su di esso
        DC.DataSet.Post;
        TabGCForm.btvGCRighi.Controller.ClearSelection;
        TabGCForm.btvGCRighi.Controller.FocusedRecord.Selected := True;
...
procedure TTabGCForm.btvGCRighiCustomDrawCell(Sender: TcxCustomGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
...
begin
  ...
  begin
    ...
    if (not VarIsNull(AViewInfo.GridRecord.Values[btvGCRighiGC_PRZVENDDACOMMESSA.Index])) and
      (AViewInfo.GridRecord.Values[btvGCRighiGC_PRZVENDDACOMMESSA.Index] = 'T') then
    begin
      BM := TBitmap.Create;
      try
        BM.Transparent := True;
    ...
    else if (not VarIsNull(AViewInfo.GridRecord.Values[btvGCRighiGC_PRESENTEINCOMMESSA.Index])) and
      (AViewInfo.GridRecord.Values[btvGCRighiGC_PRESENTEINCOMMESSA.Index] = 'T') then
    begin
      BM := TBitmap.Create;
      try
        BM.Transparent := True;
  ...
  // ---------------------------------------------------------------------------
  if LeftStr(Column.Name, 15) = 'btvGCRighiTRACK' then
  begin
  ...
  if Column.IsRight then
    ACanvas.DrawComplexFrame(AViewInfo.Bounds, LineColor, LineColor, [bRight], 1);
  if Column.IsLeft then
    ACanvas.DrawComplexFrame(AViewInfo.Bounds, LineColor, LineColor, [bLeft], 1);
  if TcxCustomGridRecordByMauri(AViewInfo.GridRecord).GetIsUltimoRecordDelGruppo then
    ACanvas.DrawComplexFrame(AViewInfo.Bounds, LineColor, LineColor, [bBottom], 1);
  ADone := True; // Suppress the default drawing
  // ===========================================================================
end;

procedure TTabGCForm.btvGCRIEP_COSTICustomDrawFooterCell(Sender: TcxGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridColumnHeaderViewInfo;
  var ADone: Boolean);
begin
...
procedure TTabGCForm.btvGCRIEP_MARGINE_COMMESSACustomDrawCell(Sender: TcxCustomGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridTableDataCellViewInfo;
  var ADone: Boolean);
begin
  inherited;
...
procedure TTabGCForm.btvGCRIEP_MARGINE_COMMESSACustomDrawFooterCell(Sender: TcxGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridColumnHeaderViewInfo;
  var ADone: Boolean);
begin
  inherited;
...
procedure TTabGCForm.btvGCRIEP_QTACustomDrawCell(Sender: TcxCustomGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridTableDataCellViewInfo;
  var ADone: Boolean);
begin
  inherited;
  // Se il valore è maggiore a zero lo visualizza in rosso (variazione del costo in aumento)
...
procedure TTabGCForm.btvGCRIEP_QTACustomDrawFooterCell(Sender: TcxGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridColumnHeaderViewInfo;
  var ADone: Boolean);
var
  AGroupRow: TcxGridGroupRow;
  ADataRow: TcxGridDataRow;
...
procedure TTabGCForm.btvGCRighiCustomDrawBandHeader(Sender: TcxGridBandedTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridBandHeaderViewInfo;
  var ADone: Boolean);
var
  LineColor: TColor;
begin
...
procedure TTabGCForm.btvGCRighiCustomDrawColumnHeader(Sender: TcxGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridColumnHeaderViewInfo; var ADone: Boolean);
var
  LineColor: TColor;
  X, Y: Integer;
begin
  ...
  if AViewInfo.Column.IsRight then
    ACanvas.DrawComplexFrame(AViewInfo.Bounds, LineColor, LineColor, [bRight], 1);
  if AViewInfo.Column.IsLeft then
    ACanvas.DrawComplexFrame(AViewInfo.Bounds, LineColor, LineColor, [bLeft], 1);
  ...
  if (AViewInfo.Column.GroupIndex > -1) or (AViewInfo.IsPressed) then
    ACanvas.DrawComplexFrame(AViewInfo.Bounds, LineColor, LineColor, [bTop, bRight, bBottom, bLeft], 1);
  ...
  begin
    ...
    if Assigned(AViewInfo.Column.Styles.Header) then
    begin
...
procedure TTabGCForm.btvGCRighiTIPODOCUMENTOGetDisplayText(Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord; var AText: String);
begin
  inherited;
  // Se si tratta di un rigo senza documento aggiunto direttamente nel
  // giornale di cantiere...
  if (VarIsNull(ARecord.Values[btvGCRighiTIPODOCUMENTO.Index])) or (ARecord.Values[btvGCRighiTIPODOCUMENTO.Index] = 'Giornale_cantiere') then
    AText := '';
end;
...
begin
  ...
  if fGC_DisableOnChangeEvents then
    Exit;
  // Ricava il dataset
  DS := Sender.DataSet;
  ...
  try
    ...
    if IsRigoGiornaleCantiere(DS.FieldByName('TIPODOCUMENTO')) then
      CopiaCampiGcNeiCampiNormali(DS);
  finally
    // Ripristina il tutto
    fGC_DisableOnChangeEvents := False;
  end;
...
procedure TTabGCForm.btvGCRighiSEGNOOPERAZIONEGetDisplayText(Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord; var AText: String);
begin
  inherited;
  if AText = '+' then
    AText := 'Carico'
...
procedure TTabGCForm.btvGCRighiSEGNOOPERAZIONECANTIEREGetDisplayText(Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord; var AText: String);
begin
  inherited;
  if AText = '+' then
    AText := 'Carico'
...
procedure TTabGCForm.btvGCRighiSOTTOCANTIERE1PropertiesInitPopup(Sender: TObject);
var
  Qry: TIB_Cursor;
  CurrPratica: Integer;
...
begin
  ...
  if QryNewGCPRATICA.IsNull or (QryNewGCPRATICA.AsInteger = 0) then
    Exit;
...
procedure TTabGCForm.btvGCRighiSEGNOOPERAZIONECANTIEREPropertiesValidate(Sender: TObject; var DisplayValue: Variant; var ErrorText: TCaption;
  var Error: Boolean);
begin
  inherited;
  if DisplayValue = 'Carico' then
    DisplayValue := '+'
  else if DisplayValue = 'Scarico' then
    DisplayValue := '-'
  else if DisplayValue = 'Commessa' then
    DisplayValue := 'C'
  else if DisplayValue = 'Montato' then
    DisplayValue := 'M'
  else if DisplayValue = 'Fatturato' then
    DisplayValue := 'F'
  else if DisplayValue = 'D.D.T.' then
    DisplayValue := 'D';
end;

procedure TTabGCForm.btvGCRighiCustomDrawFooterCell(Sender: TcxGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridColumnHeaderViewInfo; var ADone: Boolean);
var
  LineColor: TColor;
...
begin
  ...
  begin
    if LEditProperties.Alignment.Horz = taRightJustify then
      ACanvas.DrawText(AViewInfo.Text, AViewInfo.Bounds, cxAlignRight or cxAlignVCenter)
    else if LEditProperties.Alignment.Horz = taLeftJustify then
      ACanvas.DrawText(AViewInfo.Text, AViewInfo.Bounds, cxAlignLeft or cxAlignVCenter)
    else
...
begin
  Result := nil;
  for bi := 0 to btv.Bands.Count - 1 do
  begin
    for ci := 0 to btv.Bands[bi].ColumnCount - 1 do
    begin
      if btv.Bands[bi].Columns[ci].Position.VisibleColIndex = 0 then
      begin
...
begin
  ...
  if Col.Position.BandIndex > 0 then
  begin
...
begin
  ...
  if (AViewInfo is TcxGridRowFooterViewInfo) then
  begin
    ...
    // ne sono.
    while (Row <> nil) and (CurrentLevelIndex >= 0) do
    begin
      // Solo se la Row è relativa ad un Footer (not Row.IsData).
      if (not Row.IsData) and (Row.Level <= InitialLevelIndex) then
      begin
        // Compone il testo da ritornare aggiungendo il titolo del gruppo attuale.
        if FooterTitle <> '' then
          FooterTitle := Row.DisplayTexts[0] + ' --> ' + FooterTitle
        else
          FooterTitle := Row.DisplayTexts[0];
...
procedure TTabGCForm.btvGCRighiCustomDrawPartBackground(Sender: TcxCustomGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxCustomGridCellViewInfo;
  var ADone: Boolean);
var
  i, vi: Integer;
  R: TRect;
...
begin
  ...
  begin
    ...
    if AViewInfo is TcxGridRowFooterViewInfo then
      ACanvas.DrawText('       TOTALE:', FooterTitleBoundsRect, cxAlignLeft or cxAlignVCenter)
    else
      ACanvas.DrawText('TOTALE GENERALE   ', FooterTitleBoundsRect, cxAlignRight or cxAlignVCenter);
    ...
    ACanvas.DrawComplexFrame(R, CurrView.ViewInfo.FixedBandSeparatorColor, CurrView.ViewInfo.FixedBandSeparatorColor, [bRight],
      CurrView.ViewInfo.FixedBandSeparatorWidth);
    ...
    for i := 0 to CurrView.ViewInfo.HeaderViewInfo.Count - 1 do
    begin
      ...
      if (CurrView.ViewInfo.HeaderViewInfo.Items[i].Bounds.Right > CurrView.ViewInfo.ScrollableAreaBoundsHorz.Left) and
        (CurrView.ViewInfo.HeaderViewInfo.Items[i].Bounds.Left < CurrView.ViewInfo.ClientBounds.Right) then
      begin
        // Imposta i colori dello sfondo uguali allo sfondo della colonna in modo che
        // anche i totali appaiano sullo stesso sfondo.
        if Assigned(CurrView.ViewInfo.HeaderViewInfo.Items[i].Column.Styles.Footer) then
        begin
          ...
          if CurrView.ViewInfo.HeaderViewInfo.Items[i].Column.IsRight then
            ACanvas.DrawComplexFrame(R, LineColor, LineColor, [bRight], 1);
          if CurrView.ViewInfo.HeaderViewInfo.Items[i].Column.IsLeft then
            ACanvas.DrawComplexFrame(R, LineColor, LineColor, [bLeft], 1);
        end;
      end;
    end;
    ...
    if not(AViewInfo is TcxGridRowFooterViewInfo) then
    begin
...
procedure TTabGCForm.btvGCRighiCustomDrawGroupCell(Sender: TcxCustomGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxGridTableCellViewInfo; var ADone: Boolean);
var
  CurrColor: TColor;
begin
  // Inizializzazione
  ...
  if AViewInfo.Selected then
    ...
    CurrColor := (Sender as TcxGridDBBandedTableView).Styles.Group.Color;
  ...
  ACanvas.DrawComplexFrame(AViewInfo.Bounds, (Sender as TcxGridDBBandedTableView).OptionsView.GridLineColor,
    (Sender as TcxGridDBBandedTableView).OptionsView.GridLineColor, [bTop], 1);
  {
    inherited;
...
begin
  inherited;
  if PanelSelezioneColonne.Tag = 1 then
    CloseFilterPanel(PanelSelezioneColonne, SBGCSelezioneColonneOpenClose, False, 50, True)
  else
    OpenFilterPanel(PanelSelezioneColonne, SBGCSelezioneColonneOpenClose, False, True);
end;
...
procedure TTabGCForm.QryNewGCGC_COSTONETTOUNITARIO_MODChange(Sender: TField);
var
  DS: TDataSet;
begin
  inherited;
...
procedure TTabGCForm.SbGcVisPerArticoloMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited;
  // Facendo click con il pulsante DX deseleziona tutti i tipo di documento tranne
  // quello su cui si è fatto click e poi richiama la ricerca.
...
procedure TTabGCForm.GridGCLinkCustomDrawFooterCell(Sender: TdxGridReportLink; ACanvas: TCanvas; AView: TcxGridTableView; ARecord: TcxCustomGridRecord;
  AColumn: TcxGridColumn; ALevel: Integer; AnItem: TdxReportCellString; var ADone: Boolean);
var
  ARect: TRect;
  AFont: TFont;
...
begin
  ...
  try
    ...
    // ---------------------------------------------------------------------------
    if (AColumn = btvGCRighiGC_DESCRIZIONE) and (ALevel >= 0) then
    begin
    ...
    else if (AColumn = btvGCRighiGC_DESCRIZIONE) and (ALevel < 0) then
    begin
      // Impostazione del font per la stampa del titolo 'Tot';
      AFont.Color := clBlue;
      AFont.Size := 8 * AScale;
    ...
    begin
      ...
      if ((AColumn = btvGCCOMMESSA_QTA) or (AColumn = btvGCGIACENZA_QTA) or (AColumn = btvGCMONTATO_QTA) or (AColumn = btvGCRIEP_QTA) or
        (AColumn = btvGCRIEP_PERC_QTA)) and (VarToStr(TcxGridGroupRow(ARecord.ParentRecord).Value) <> 'Manodopera') then
        AnItem.Text := '';
      // Le colonne delle sezioni di riepilogo sono stampate in rosso se il dato è peggiorativo rispetto
      // a quanto preventivato
      if (((AColumn = btvGCRIEP_QTA) or (AColumn = btvGCRIEP_COSTI) or (AColumn = btvGCRIEP_PERC_QTA) or (AColumn = btvGCRIEP_PERC_COSTI)) and
        (LeftStr(AnItem.Text, 1) = '+')) or
        (((AColumn = btvGCRIEP_MARGINE_COMMESSA) or (AColumn = btvGCRIEP_MARGINE_FATTURATO) or (AColumn = btvGCRIEP_MARGINE_MONTATO)) and
        (LeftStr(AnItem.Text, 1) = '-')) or (((AColumn = btvGCRIEP_PERC_MARGINE_COMMESSA) or (AColumn = btvGCRIEP_PERC_MARGINE_FATTURATO) or
        (AColumn = btvGCRIEP_PERC_MARGINE_MONTATO)) and (LeftStr(AnItem.Text, 1) = '-')) then
        AFont.Color := clRed;
...
begin
  ...
  if SaltaUltimoLivello then
    Dec(InitialLevelIndex);
  // ALl'inizio contiene lo stesso valore di InitialLevelIndex ma poi viene usato durante l'elaborazione
  // per ciclare tra i livelli precedenti e comporre così il titolo completo con tutti i testi di tutti i gruppi
  // di tutti i Livelli di gruppo ai quali il footer è relativo.
...
procedure TTabGCForm.GridGCLinkCustomDrawCell(Sender: TdxGridReportLink; ACanvas: TCanvas; AView: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AColumn: TcxGridColumn; AnItem: TAbstractdxReportCellData; var ADone: Boolean);
var
...
begin
  ...
  try
    ...
    begin
      ...
      // (Checkbox)...
      if (CurrFieldName = 'GC_DESCRIZIONE_MOD') or (CurrFieldName = 'GC_QTA_MOD') or (CurrFieldName = 'GC_COSTONETTOUNITARIO_MOD') or
        (CurrFieldName = 'GC_RICARICO_MOD') then
      begin
        // NB: IL calcolo delle dimensioni del TRect l'ho fatto venire perchè non avevo più tempo ma è da rivedere
        R.Left := R.Left + ((R.Width + ImageListForPrint.Width) div 2);
//        R.Top := R.Top + ((R.Height + ImageListForPrint.Height) div 2);
        R.Width := ImageListForPrint.Width * 4;
        R.Height := ImageListForPrint.Height * 4;

// NB: MOMENTANEAMENTE DISABILITATO PERCHE' NON FUNZIONA BENE
//        if ARecord.Values[AColumn.Index] = 'T' then
//          Sender.DrawGraphic(ACanvas, R, R, ImageListForPrint, 0, nil, True, True, clWhite);
      end
      // Se invece è la colonna che indica se il prezzo di vendita è COME DA COMMESSA...
      else if (CurrFieldName = 'GC_PRZVENDDACOMMESSA') then
      begin
        // NB: IL calcolo delle dimensioni del TRect l'ho fatto venire perchè non avevo più tempo ma è da rivedere
        R.Left := R.Left + ((R.Width + ImageListForPrint.Width) div 2);
//        R.Top := R.Top + ((R.Height + ImageListForPrint.Height) div 2);
...
// NB: MOMENTANEAMENTE DISABILITATO PERCHE' NON FUNZIONA BENE
//        if ARecord.Values[btvGCRighiGC_PRZVENDDACOMMESSA.Index] = 'T' then
//          Sender.DrawGraphic(ACanvas, R, R, ImageListForPrint, 1, nil, True, True, clWhite)
//        else if ARecord.Values[btvGCRighiGC_PRESENTEINCOMMESSA.Index] = 'T' then
//          Sender.DrawGraphic(ACanvas, R, R, ImageListForPrint, 2, nil, True, True, clWhite);
      end
      ...
      begin
        ...
        if (CurrFieldName = 'GC_COSTONETTOUNITARIO') or (CurrFieldName = 'GC_RICARICO') or (CurrFieldName = 'GC_GUADAGNOUNITARIO') or
          (CurrFieldName = 'GC_PRZVEND') then
        begin
          AFont.Style := [fsItalic];
        end
        else if (CurrFieldName = 'GC_COSTONETTOIMPORTO') or (CurrFieldName = 'GC_GUADAGNOIMPORTO') or (CurrFieldName = 'GC_PRZVENDIMPORTO') then
        begin
          AFont.Style := [];
        end;
        // Le colonne delle sezioni di riepilogo sono stampate in rosso se il dato è peggiorativo rispetto
        // a quanto preventivato
        if (((CurrFieldName = 'RIEP_QTA') or (CurrFieldName = 'RIEP_COSTI') or (CurrFieldName = 'RIEP_PERC_QTA') or (CurrFieldName = 'RIEP_PERC_COSTI')) and
          (ARecord.Values[AColumn.Index] > 0)) or
          (((CurrFieldName = 'RIEP_MARGINE_COMMESSA') or (CurrFieldName = 'RIEP_MARGINE_FATTURATO') or (CurrFieldName = 'RIEP_MARGINE_MONTATO')) and
          (ARecord.Values[AColumn.Index] < 0)) or (((CurrFieldName = 'RIEP_PERC_MARGINE_COMMESSA') or (CurrFieldName = 'RIEP_PERC_MARGINE_FATTURATO') or
          (CurrFieldName = 'RIEP_PERC_MARGINE_MONTATO')) and (ARecord.Values[AColumn.Index] < 0)) then
          AFont.Color := clRed;
        // VALORE CELLA
        // Determinazione dell'allineamento orizzontale da utilizzare
        if Assigned(LEditProperties) then
        begin
          if LEditProperties.Alignment.Horz = taLeftJustify then
            HorizontalAlign := taLeft
          else if LEditProperties.Alignment.Horz = taRightJustify then
            HorizontalAlign := taRight
          else if LEditProperties.Alignment.Horz = taCenter then
            HorizontalAlign := taCenterX;
        end;
        // ###########
        // Se è un dato numerico e il suo valore è zero non lo stampa per niente
        if (not VarIsNull(ARecord.Values[AColumn.Index])) and VarIsNumeric(ARecord.Values[AColumn.Index]) and (ARecord.Values[AColumn.Index] = 0) then
        begin
          AText := '';
        end
        else
        ...
        if Pos('TRACK_', CurrFieldName) > 0 then
          AText := ElaboraDescrizioneTracking(AText, False, ARecord);
        // Tracciamento del valore
        Sender.DrawText(ACanvas, R, 0, AText, AFont, clWhite, HorizontalAlign, taTop, True, True, False);
      end;
      // BORDO DX
      if AColumn.IsRight then
      begin
      ...
      // BORDO INFERIORE
      if TcxCustomGridRecordByMauri(ARecord).GetIsUltimoRecordDelGruppo then
      begin
    ...
    begin
      ...
      if (ARecord.Level = 0) and ((not ARecord.Expanded) or (AView.GroupedItemCount > 1)) then
      begin
        R.Left := AnItem.BoundsRect.Left;
...
procedure TTabGCForm.GridGCLinkCustomDrawBandCell(Sender: TdxGridReportLink; ACanvas: TCanvas; AView: TcxGridBandedTableView; ABand: TcxGridBand;
  AnItem: TdxReportCellString; var ADone: Boolean);
var
  ARect: TRect;
  AFont: TFont;
...
procedure TTabGCForm.btvGCRighiGC_RICARICOGetDataText(Sender: TcxCustomGridTableItem; ARecordIndex: Integer; var AText: String);
var
  Value: Variant;
begin
  inherited;
  ...
  if VarIsNull(Value) then
    ...
    AText := FloatToStr(SimpleRoundTo(Value, DM1.DecimaliMarginiPercentuali * (-1))) + '%';
end;

procedure TTabGCForm.GridGCLinkCustomDrawHeaderCell(Sender: TdxGridReportLink; ACanvas: TCanvas; AView: TcxGridTableView; AColumn: TcxGridColumn;
  AnItem: TdxReportCellString; var ADone: Boolean);
var
  AText: String;
  R: TRect;
...
procedure TTabGCForm.dxPrinterCustomDrawPageHeader(Sender: TObject; AReportLink: TBasedxReportLink; ACanvas: TCanvas; APageIndex: Integer; var ARect: TRect;
  ANom, ADenom: Integer; var ADefaultDrawText, ADefaultDrawBackground: Boolean);
begin
  inherited;
...
procedure TTabGCForm.dxPrinterCustomDrawPageFooter(Sender: TObject; AReportLink: TBasedxReportLink; ACanvas: TCanvas; APageIndex: Integer; var ARect: TRect;
  ANom, ADenom: Integer; var ADefaultDrawText, ADefaultDrawBackground: Boolean);
begin
  inherited;
...
procedure TTabGCForm.btvGCGIACENZA_QTAGetDataText(Sender: TcxCustomGridTableItem; ARecordIndex: Integer; var AText: String);
var
  DC: TcxCustomDataController;
  Tipologia: String;
  Value: Variant;
begin
  ...
  Tipologia := '';
  if not VarIsNull(DC.Values[ARecordIndex, btvGCTIPOLOGIA.Index]) then
    Tipologia := DC.Values[ARecordIndex, btvGCTIPOLOGIA.Index];
  ...
  if (not GC_CantiereSelezionato) and (((Tipologia <> 'Materiali / Apparecchi') and (Tipologia <> 'Manodopera') and (Tipologia <> 'Altre spese')) or
    ((Tipologia = 'Materiali / Apparecchi') and ((RightStr(Sender.Name, 4) = '_QTA') or (RightStr(Sender.Name, 12) = '_PRZUNITVEND') or
    (RightStr(Sender.Name, 11) = '_PRZUNITACQ') or (RightStr(Sender.Name, 9) = '_RICARICO') or (RightStr(Sender.Name, 17) = '_GUADAGNOUNITARIO'))) or
    ((Tipologia = 'Altre spese') and ((RightStr(Sender.Name, 4) = '_QTA') or (RightStr(Sender.Name, 12) = '_PRZUNITVEND') or
    (RightStr(Sender.Name, 11) = '_PRZUNITACQ') or (RightStr(Sender.Name, 9) = '_RICARICO') or (RightStr(Sender.Name, 17) = '_GUADAGNOUNITARIO')))) then
  begin
    AText := '';
  ...
  begin
    ...
    begin
      Value := Sender.DataBinding.DataController.Values[ARecordIndex, Sender.Index];
      if VarIsNull(Value) or (Value = 0) then
        AText := ''
      else
        AText := FloatToStr(SimpleRoundTo(Value, DM1.DecimaliMarginiPercentuali * (-1))) + '%';
    end;
    ...
    if (RightStr(Sender.Name, 8) = 'RIEP_QTA') or (RightStr(Sender.Name, 10) = 'RIEP_COSTI') or (RightStr(Sender.Name, 13) = 'RIEP_PERC_QTA') or
      (RightStr(Sender.Name, 15) = 'RIEP_PERC_COSTI') then
    begin
      Value := Sender.DataBinding.DataController.Values[ARecordIndex, Sender.Index];
      if (not VarIsNull(Value)) and (Value > 0) then
        AText := '+' + Trim(AText);
    end;
  end;
end;
...
begin
  ...
  if DM1.Messaggi('Elimina righi dal Giornale di Cantiere', 'Eliminare tutti i righi selezionati?', '', [mbYes, mbNo], 0, nil) <> mrYes then
    Exit;
  if DM1.Messaggi('Elimina righi dal Giornale di Cantiere', 'Sicuro/a?', '', [mbYes, mbNo], 0, nil) <> mrYes then
    Exit;
...
begin
  ...
  if DataSet.FieldByName('TIPODOCUMENTO').AsString <> 'Giornale_cantiere' then
  begin
    DM1.Messaggi('Elimina Rigo', 'ATTENZIONE !!!'#13#13'Il rigo relativo all''articolo "' + DataSet.FieldByName('GC_DESCRIZIONE').AsString +
      '" relativo al documento "' + DataSet.FieldByName('TIPODOCUMENTO').AsString + ' ' + DataSet.FieldByName('NUMORDPREV').AsString +
      DataSet.FieldByName('REGISTRO').AsString + ' del ' + DataSet.FieldByName('DATADOCUMENTO').AsString + ' non è eliminabile.',
      'NB: Le righe collegate ai documenti non sono eliminabili dal Giornale di Cantiere ma solo dall''interno del documento stesso.', [mbOk], 0, nil);
    Abort;
  end;
  ...
  if DataSet.FieldByName('TIPOLOGIA').AsString = 'Materiali / Apparecchi' then
  begin
...
procedure TTabGCForm.btvGCRighiKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  ...
  if Key = 46 then
    ClientiForm.RxSpeedButtonEliminaClick(ClientiForm.RxSpeedButtonElimina);
end;

procedure TTabGCForm.btvGCRighiSOTTOCANTIERE2PropertiesInitPopup(Sender: TObject);
var
  Qry: TIB_Cursor;
  CurrPratica: Integer;
  CurrDataPratica: TDateTime;
...
procedure TTabGCForm.btvGCRighiSOTTOCANTIERE3PropertiesPopup(Sender: TObject);
var
  Qry: TIB_Cursor;
  CurrPratica: Integer;
  CurrDataPratica: TDateTime;
...
procedure TTabGCForm.btvGCRighiEditing(Sender: TcxCustomGridTableView; AItem: TcxCustomGridTableItem; var AAllow: Boolean);
var
...
begin
  ...
  if (Sender.Controller as TcxGridTableController).FocusedRow.IsFilterRow then
  begin
    AAllow := True;
    Exit;
  end;
  ...
  if Sender.Controller.NewItemRecordFocused and VarIsNull(Sender.Controller.FocusedRecord.Values[btvGCRighiGC_SEZIONE.Index]) then
  begin
    Sezione := 'Giacenza';
  end
  else
  ...
  if Sender.Controller.NewItemRecordFocused and VarIsNull(Sender.Controller.FocusedRecord.Values[btvGCRighiTIPOLOGIA.Index]) then
  begin
  ...
  if Sender.Controller.NewItemRecordFocused and VarIsNull(Sender.Controller.FocusedRecord.Values[btvGCRighiTIPODOCUMENTO.Index]) then
  begin
    IsDocument := False;
  end
  else
  ...
  // GC_DATADOCUMENTO
  if AItem = btvGCRighiGC_DATADOCUMENTO then
  begin
    AAllow := (not IsDocument);
    // SEGNOOPERAZIONE
  end
  else if AItem = btvGCRighiSEGNOOPERAZIONE then
  begin
    AAllow := (Tipologia = 'Materiali / Apparecchi') and (not IsDocument);
    // SEGNOOPERAZIONECANTIERE
  end
  else if AItem = btvGCRighiSEGNOOPERAZIONECANTIERE then
  begin
    AAllow := (Tipologia = 'Materiali / Apparecchi') and (not IsDocument);
    // GC_CODICEARTICOLO
  end
  else if AItem = btvGCRighiGC_CODICEARTICOLO then
  begin
    AAllow := (Tipologia = 'Materiali / Apparecchi') and (not IsDocument);
    // GC_DESCRIZIONE_MOD
  end
  else if AItem = btvGCRighiGC_DESCRIZIONE_MOD then
  begin
    AAllow := True;
    // GC_DESCRIZIONE
  end
  else if AItem = btvGCRighiGC_DESCRIZIONE then
  begin
    AAllow := True;
    // UNITA DI MISURA
  end
  else if AItem = btvGCRighiUNITADIMISURA then
  begin
    AAllow := (Tipologia = 'Materiali / Apparecchi') and (not IsDocument);
    // GC_QTA_MOD
  end
  else if AItem = btvGCRighiGC_QTA_MOD then
  begin
    AAllow := (Tipologia <> 'Altre spese');
    // GC_QTA
  end
  else if AItem = btvGCRighiGC_QTA then
  begin
    AAllow := (Tipologia <> 'Altre spese');
    // GC_COSTONETTOUNOTARIO_MOD
  end
  else if AItem = btvGCRighiGC_COSTONETTOUNITARIO_MOD then
  begin
    AAllow := (Tipologia = 'Materiali / Apparecchi') or (Tipologia = 'Altre spese');
    // GC_COSTONETTOUNOTARIO
  end
  else if AItem = btvGCRighiGC_COSTONETTOUNITARIO then
  begin
    AAllow := (Tipologia = 'Materiali / Apparecchi') or (Tipologia = 'Altre spese');
    // GC_RICARICO_MOD
  end
  else if AItem = btvGCRighiGC_RICARICO_MOD then
  begin
    AAllow := (Tipologia = 'Materiali / Apparecchi') or (Tipologia = 'Altre spese');
    // GC_RICARICO
  end
  else if AItem = btvGCRighiGC_RICARICO then
  begin
    AAllow := (Tipologia = 'Materiali / Apparecchi') or (Tipologia = 'Altre spese');
    // SOTTOCANTIERE 1
  end
  else if (AItem = btvGCRighiSOTTOCANTIERE1) or (AItem = btvGCRighiSOTTOCANTIERE2) or (AItem = btvGCRighiSOTTOCANTIERE3) then
  begin
    AAllow := True;
  end;
end;

procedure TTabGCForm.btvGCGIACENZA_QTAGetDisplayText(Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord; var AText: String);
begin
  inherited;
...
procedure TTabGCForm.btvGCRighiTRACK_PREVENTIVOGetDisplayText(Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord; var AText: String);
begin
...
procedure TTabGCForm.btvGCTcxGridDBDataControllerTcxDataSummaryFooterSummaryItems18GetText(Sender: TcxDataSummaryItem; const AValue: Variant;
...
procedure TTabGCForm.btvGCTcxGridDBDataControllerTcxDataSummaryFooterSummaryItems19G(Sender: TcxDataSummaryItem; const AValue: Variant; AIsFooter: Boolean;
  var AText: string);
begin
  inherited;
...
begin
  ...
  Prec := AText;
  AText := Trim(AText);
  if not VarIsNull(ARecord.Values[btvGCRighiTIPOLOGIA.Index]) then
    Tipologia := ARecord.Values[btvGCRighiTIPOLOGIA.Index];
  ...
  begin
    ...
    if (AText = '') or (AText = 'n.c.') then
    begin
      Result := Prec;
      Exit;
    end;
    // Compone il risultato
    Result := '   ' + DM1.ExpDocToDocType(AText) + ' n° ' + IntToStr(DM1.ExpDocToDocNum(AText)) + DM1.ExpDocToDocReg(AText) + ' del ' +
      DM1.ExpDocToDocDateStr(AText);
    Prec := DM1.ExpDocToDocRagioneSocialeStr(AText);
    if Prec <> '' then
      Result := Result + 'di ' + Prec + '...'
  end
  else
  begin
    // NB: Se è un rigo di manodopera mette la dicitura "n.d."
    if (Tipologia <> 'Materiali / Apparecchi') then
    begin
      Result := 'n.d.';
      Exit;
    end;
...
procedure TTabGCForm.dxPrinterStartGenerateReport(Sender: TObject; AReportLink: TBasedxReportLink);
begin
  inherited;
...
procedure TTabGCForm.dxPrinterEndGenerateReport(Sender: TObject; AReportLink: TBasedxReportLink);
begin
  inherited;
  // In stampa allarga le colone del tracking
...
procedure TTabGCForm.btvGCRighiEndDrag(Sender, Target: TObject; X, Y: Integer);
begin
  inherited;
  // In base al tipo del mittente
  if Target is TListView then
...
begin
  ...
  if FR = nil then
    Exit;
  if VarIsNull(FR.Values[btvGCRighiTIPODOCUMENTO.Index]) then
    FR.Values[btvGCRighiTIPODOCUMENTO.Index] := 'Giornale_cantiere';
  if VarIsNull(FR.Values[btvGCRighiNUMORDPREV.Index]) then
    FR.Values[btvGCRighiNUMORDPREV.Index] := StrToInt(ClientiForm.PraticaCorrente);
  if VarIsNull(FR.Values[btvGCRighiREGISTRO.Index]) then
    FR.Values[btvGCRighiREGISTRO.Index] := DM1.RegistroDefault;
  if VarIsNull(FR.Values[btvGCRighiDATADOCUMENTO.Index]) then
    FR.Values[btvGCRighiDATADOCUMENTO.Index] := StrToDate(ClientiForm.DataPraticaCorrente);
  if VarIsNull(FR.Values[btvGCRighiPROGRIGO.Index]) then
    FR.Values[btvGCRighiPROGRIGO.Index] := NextProgRigo;
  if VarIsNull(FR.Values[btvGCRighiPROGRIGO2.Index]) then
    FR.Values[btvGCRighiPROGRIGO2.Index] := (-1);
  if VarIsNull(FR.Values[btvGCRighiTIPOLOGIA.Index]) then
    FR.Values[btvGCRighiTIPOLOGIA.Index] := 'Materiali / Apparecchi';
  if VarIsNull(FR.Values[btvGCRighiGC_SEZIONE.Index]) then
    FR.Values[btvGCRighiGC_SEZIONE.Index] := 'Giacenza';
  if VarIsNull(FR.Values[btvGCRighiSEGNOOPERAZIONECANTIERE.Index]) then
    FR.Values[btvGCRighiSEGNOOPERAZIONECANTIERE.Index] := '+';
  if VarIsNull(FR.Values[btvGCRighiSEGNOOPERAZIONE.Index]) then
    FR.Values[btvGCRighiSEGNOOPERAZIONE.Index] := '=';
  if VarIsNull(FR.Values[btvGCRighiRIFPRATICA.Index]) then
    FR.Values[btvGCRighiRIFPRATICA.Index] := ClientiForm.PraticaCorrente + ' - ' + ClientiForm.DataPraticaCorrente + ' - ' + ClientiForm.DescPraticaCorrente;
end;
...
begin
  ...
  if CurrTipologiaText = 'NONE' then
    CurrTipologia := DC.DisplayTexts[RI, btvGCRighiTIPOLOGIA.Index]
  else
    CurrTipologia := CurrTipologiaText;
  // Se il campo OperaIndex del rigo non è nullo lo assegna alla variabile
  if not VarIsNull(DC.Values[RI, btvGCRighiOPERAINDEX.Index]) then
    OperaIndex := DC.Values[RI, btvGCRighiOPERAINDEX.Index];
  ...
  if Trim(CurrTipologia) = '' then
  begin
    if OperaIndex = -1 then
      CurrTipologia := 'Materiali / Apparecchi'
    else
      CurrTipologia := DM1.Manodopera[OperaIndex].Descrizione;
  end;
...
begin
  ...
  if CurrTipologia = 'Materiali / Apparecchi' then
  begin
    SetMaterialiApparecchiInsertSQL;
    SetMaterialiApparecchiUpdateSQL;
    // Altre spese
  end
  else if CurrTipologia = 'Altre spese' then
  begin
...
procedure TTabGCForm.btvGCRighiFocusedRecordChanged(Sender: TcxCustomGridTableView; APrevFocusedRecord, AFocusedRecord: TcxCustomGridRecord;
  ANewItemRecordFocusingChanged: Boolean);
begin
  inherited;
  // IN base alla tipologia del rigo attuale imposta le query per L'Insert/Update appropriate
...
procedure TTabGCForm.btvGCRighiTIPOLOGIAGetDataText(Sender: TcxCustomGridTableItem; ARecordIndex: Integer; var AText: String);
var
  OperaIndex: Integer;
begin
  inherited;
...
procedure TTabGCForm.btvGCRighiGC_SEZIONEGetDataText(Sender: TcxCustomGridTableItem; ARecordIndex: Integer; var AText: String);
begin
  inherited;
...
procedure TTabGCForm.btvGCRighiEditValueChanged(Sender: TcxCustomGridTableView; AItem: TcxCustomGridTableItem);
begin
  inherited;
  // IN base alla tipologia del rigo attuale imposta le query per L'Insert/Update appropriate
  // Materiali / Apparecchi
...
begin
  ...
  if DataSet.FieldByName('GUID').IsNull then
  begin
    NewGuid := DM1.GUIDAsString;
    DataSet.FieldByName('GUID').Value := NewGuid;
    if DataSet.FieldByName('GUID_REF').IsNull then
      DataSet.FieldByName('GUID_REF').Value := NewGuid;
  end;
end;
...
procedure TTabGCForm.RigamanualesoloMaterialiApparecchi1Click(Sender: TObject);
begin
  inherited;
  NuovoArticoloGC;
end;
...
begin
  ...
  begin
    ...
    if DocType = 'Giornale_cantiere' then
      Exit;
    // Se è un rapporto giornaliero...
    if DocType = 'Rapp.giorn.' then
    begin
...
var
  ...
  begin
    ...
    if TmpStr <> '' then
    begin
      MI.Caption := DM1.ExpDocToDocType(DC.Values[RI, CurrItemIndex]) + ' n. ' + IntToStr(DM1.ExpDocToDocNum(DC.Values[RI, CurrItemIndex])) +
        DM1.ExpDocToDocReg(DC.Values[RI, CurrItemIndex]) + ' del ' + DateToStr(DM1.ExpDocToDocDate(DC.Values[RI, CurrItemIndex]));
      MI.Visible := True;
    end
    else
      MI.Visible := False;
...
begin
  ...
  for RI := 0 to OpenDocMenu.Items.Count - 1 do
    if not OpenDocMenu.Items[RI].IsLine then
      OpenDocMenu.Items[RI].Visible := False;
  // Verifica permessi
  if not(DM1.ModCtrl(MOD_GIORNALE_CANTIERE) > 0) then
    Exit;
  // Solo se siamo su un rigo di dati
  if ((GridGC.FocusedView as TcxGridDBBandedTableView).Controller.FocusedRecord = nil) or
    (not(GridGC.FocusedView as TcxGridDBBandedTableView).Controller.FocusedRecord.IsData) then
    Exit;
  // Inizializzazione
  DC := GridGC.FocusedView.DataController;
  RI := DC.FocusedRecordIndex;
  ...
  begin
    ...
    if (TmpStr <> '') and DM1.ArticoloEsistente(TmpStr) then
    begin
  ...
  begin
    ...
    if TmpStr <> 'Giornale_cantiere' then
    begin
...
begin
  ...
  if Trim(DC.DisplayTexts[RI, TrackColID]) = '' then
    Exit;
  // Ricava i dati del documento in alcune variabili per comodità
  ...
  // Se è un rigo inserito a mano nel Giornale di cantiere esce subito
  if CurrTipoDoc = 'Giornale_cantiere' then
    Exit;
  // Crea e visualizza la form con il documento selezionato
...
procedure TTabGCForm.GCCantieriApertiChiusiMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
  CheckIndex: Integer;
  CurrCheckListBox: TCheckListBox;
  i: Integer;
...
procedure TTabGCForm.btvGCRighiDataControllerSortingChanged(Sender: TObject);
begin
  inherited;
...
// -----------------------------------------------------------------------------
procedure TTabGCForm.btvGCRighiDataControllerSummaryAfterSummary(ASender: TcxDataSummary);
...
// CALCOLO TOTALI E SUBTOTALI
// -----------------------------------------------------------------------------
procedure TTabGCForm.btvGCDataControllerSummaryAfterSummary(ASender: TcxDataSummary);
...
procedure TTabGCForm.btvGCDataControllerSummaryFooterSummaryItemsSummary(ASender: TcxDataSummaryItems; Arguments: TcxSummaryEventArguments;
  var OutArguments: TcxSummaryEventOutArguments);
var
  LValue: Extended;
...
procedure TTabGCForm.SetSez_Visible_DaFatturare_Commessa(const Value: Boolean);
begin
...
procedure TTabGCForm.SetSez_Visible_DaFatturare_Giacenza(const Value: Boolean);
begin
...
procedure TTabGCForm.SetSez_Visible_DaFatturare_Montato(const Value: Boolean);
begin
...
procedure TTabGCForm.SetSez_Visible_DaMontare_Commessa(const Value: Boolean);
begin
...
procedure TTabGCForm.SetSez_Visible_DaMontare_Giacenza(const Value: Boolean);
begin
...
begin
  inherited;
  if SbGcVisMemSetPredef.Down then
  begin
...
begin
  ...
  QryNewGCRIFDOC.Value := QryNewGCTIPODOCUMENTO.AsString + ' ' + QryNewGCNUMORDPREV.AsString + QryNewGCREGISTRO.AsString + ' del ' +
    QryNewGCDATADOCUMENTO.AsString;
  ...
  // DISPONIBILE A MAGAZZINO
  if DM1.TableProgressiviMAG_ORDINATONELDISPONIBILE.AsBoolean then
    QryNewGCMAG_DISPONIBILE.Value := QryNewGCMAG_GIACENZA.AsFloat - QryNewGCMAG_IMPEGNATO.AsFloat + QryNewGCMAG_ORDINATO.AsFloat
  else
    QryNewGCMAG_DISPONIBILE.Value := QryNewGCMAG_GIACENZA.AsFloat - QryNewGCMAG_IMPEGNATO.AsFloat;
end;
...
begin
  ...
  if not btvGC.FilterRow.Visible then
    btvGC.DataController.Filter.Clear;
  // Attiva/Disattiva la Filter Row
  btvGCRighi.FilterRow.Visible := (Sender as TSpeedButton).Down;
  if not btvGCRighi.FilterRow.Visible then
    btvGCRighi.DataController.Filter.Clear;
end;
